...
Якщо не хочете знову бачити майстер налаштувань, відмітьте позначку *Не показувати майстер при повторному вході*. Щоб викликати Майстер повторно, натисніть на позначку "шестерні" біля перемикача мови платформи.

.. image:: pics_instruktsia_korystuvacha_obminy_paketami/instruktsia_korystuvacha_obminy_paketami_1_master.png
   :align: center
...
.. image:: pics_instruktsia_korystuvacha_obminy_paketami/korystuvacha_obminy_paketami_1.png
   :align: center
...
При створенні чи редагуванні комплекта відкриється форма обробки комплекта, що містить наступні вкладки:
 ...
 .. image:: pics_instruktsia_korystuvacha_obminy_paketami/korystuvacha_obminy_paketami_2.png
    :align: center
...
.. image:: pics_instruktsia_korystuvacha_obminy_paketami/korystuvacha_obminy_paketami_filter_1.png
   :align: center 
...
Пошук виконується за наступними атрибутами:
 ...
 - Тип комплекта (для фільтрування за типом комплекта необхідно обрати відправника у відповідному полі фільтра)
...
**5.3 Створення ярлика (Шаблони фільтрів)**

Для спрощення фільтрації комплектів у розділах, реалізована можливість зберегти часто використовуваняі параметри фільтра. Для цього натисніть кнопку "Додати ярлик" (є у кожному розділі - під назвою розділу), заповніть необхідні параметри і натисніть кнопку «Зберегти»:

.. image:: pics_instruktsia_korystuvacha_obminy_paketami/korystuvacha_obminy_paketami_filter_3.png
   :align: center
...
.. image:: pics_instruktsia_korystuvacha_obminy_paketami/korystuvacha_obminy_paketami_3.png
   :align: center
...
Обов’язкові для конкретного комплекта документи позначаються відміткою |иконка-звезда| (зірочка). Зашифровані документи позначаються відміткою |иконка-щит| (щит). У списку документів відображається назва файлу та кількість накладених підписів.
...
Документи у форматі PDF не обов'язково скачувати для перегляду - лише для таких документів можливий перегляд прямо у вікні браузера. Для цього натисніть на піктограмму |иконка-око| (око).
...
.. note:: Довкладення може додати лише отримувач комплекта  
