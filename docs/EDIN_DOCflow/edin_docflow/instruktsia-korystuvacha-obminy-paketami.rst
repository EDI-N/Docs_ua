...
У *Налаштування - Налаштування комплектів документів*, при :ref:`додаванні звязку пакета з типами документів <пакет-тип документа>` можливо налаштувати правила роботи з документом.
