...
9 Візуалізація ЕЦП
----------------------------------------
У підписаних документах з відкритим доступом та у форматі PDF відтепер буде відображено візуалізацію ЕЦП у листі підписання при скачуванні архіва.
Обовязкова умова також увімкнути "Доступ до документу" у :ref:`_Налаштування-доступу-для-провайдера`.

Внизу сторінки буде відображено штамп "Документ підписаний..." та вказано  id документа.

фото

Також, у структорваному документі
