...
9 Візуалізація ЕЦП
----------------------------------------
У підписаних документах без шифрування та у форматі PDF відтепер буде відображено візуалізацію ЕЦП у листі підписання при скачуванні архіва.

Обовязкова умова - увімкнути "Доступ до документу" у :ref:`_Налаштування-доступу-для-провайдера`.
