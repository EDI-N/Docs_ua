...
1. Створити ієрархічний довідник. Меню "Налаштування компанії" → "Мої компанії" → відкрити форму редагування компанії (кліком по назві) → вкладка "Довідники" → кнопка "Створити".
...
3. Додати документ в налаштування узгодження, вказавши фінальні значення довідника. Меню "Управління доступом" → "Налаштування узгодження" → вкладка "Типи документів".
...
1. У пакеті по кожному файлу документа заповнити "фінальні" значення довідників  "і відправити пакет.
