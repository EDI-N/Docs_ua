...
При підписанні документа документа, є можливість вибрати яким  Електронний ключем підписати документ - за допомогою налаштованого КЕП/ЕЦП, чи з USB-ключем.

Длявикористання токена, у документі що потребує підписанняЮ натиснути **Підписати**, потім вибрати **Робота з захищеним носієм (Token)**.

.. image:: pics_instruktsia-nastroyka-ecp/instruktsia_nastroyka_ecp_14.png
   :align: center

Для роботи із зовнішнім токеном, необхідно здійснити налаштування й встановити необхідне програмне забезпечення:
...
.. _«Інструкція по роботі з крипто бібліотеками і захищеним носієм»: https://wiki.edi-n.com/ru/latest/services/EDIN_DOCflow/edin_docflow/instruktsia-avtorizatsia.html
