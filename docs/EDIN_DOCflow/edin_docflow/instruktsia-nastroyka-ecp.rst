...
При підписанні документа документа, є можливість вибрати яким  Електронний ключем підписати документ - за допомогою налаштованого КЕП/ЕЦП, чи **Робота з захищеним носієм (Token)**.
Для роботи із зовнішнім токеном, необхідно здійснити налаштування й необхідне програмне забезпечення для роботи з Token:
