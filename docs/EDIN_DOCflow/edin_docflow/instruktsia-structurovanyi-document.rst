...
.. admonition:: Зверніть увагу!
   ...
   Тег "ref" заповнюється посиланням на пакет лише при формуванні зовнішнього документа у розділі "Документи", наприклад: «ref»: «pack.senderCompany.companyId». 
...
|          | - **pack** - при посиланні на поле з пакета (лише для зовнішніх документів що формуються у розділі "Документи")                                                               | "ref": "dict.1"                                                                            |
