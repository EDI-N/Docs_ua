...
.. _«Інструкції з авторизації»: https://wiki.edi-n.com/uk/latest/services/EDIN_DOCflow/edin_docflow/instruktsia-avtorizatsia.html
...
.. admonition:: Зверніть увагу!
   ...
   Тег "ref" заповнюється посиланням на комплект лише при формуванні зовнішнього документа у розділі "Документи", наприклад: «ref»: «pack.senderCompany.companyId». 
   При формуванні внутрішнього документа у розділі "Внутрішні документи компанії" потрібно використовувати посилання на документ, наприклад: «ref»: «doc.senderCompany».
...
|   Тег    |                                                                                     Опис                                                                                      |                                           Приклад                                            |
+==========+===============================================================================================================================================================================+==============================================================================================+
| index    | В даному параметрі вказується індекс (ID) рядка для масив узначень, нумерація починається з 0.                                                                                | "index": 0                                                                                   |
|          | Якщо вказати -1 то для всіх рядків буде застосовуватися; Якщо вказати значення більше -1 то тільки в зазначеному рядку.                                                       |                                                                                              |
+----------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+
| template | В параметрі задається шаблон даних для відповідного елемента                                                                                                                  | 1."template": "Простий текст з використанням функції отримання поточної дати з форматуванням |
...
|          | текстом реалізовані наступні можливості:                                                                                                                                      | 2. "{"index": -1, "template": "#rowIndex#"}"                                                 |
|          |                                                                                                                                                                               |                                                                                              |
...
|          |                                                                                                                                                                               |                                                                                              |
|          | Для того щоб автоматично проставлявся порядковий номер документа в табличній частині, потрібно, в структурі в поле template вказати "# rowIndex #".                           |                                                                                              |
|          | Також необхідно використовувати "index": -1 для нумерації у всьому документі.                                                                                                 |                                                                                              |
|          | Початкове значення = 1. Кожне наступне значення на 1 більше попереднього. (2)                                                                                                 |                                                                                              |
|          |                                                                                                                                                                               |                                                                                              |
+----------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------+
...
|          | - **pack** - при посиланні на поле з комплекта (лише для зовнішніх документів що формуються у розділі "Документи")                                                            | "ref": "dict.1"                                                                              |
...
.. _«Інструкції бізнес-адміністратора»: https://wiki.edi-n.com/uk/latest/services/EDIN_DOCflow/edin_docflow/instruktsia-biznes-administratora.html
