...
**5.1.4 Налаштування доступу для провайдера**

Щоб відкрити доступ провайдеру до зовнішнього або внутрішнього документа, натисніть відповідну кноаку навпроти документу - **Доступ до документу**.
...
У документах з відкритим доступом та у форматі PDF відтепер буде відображено візуалізацію ЕЦП у лісті підписання у архіві.

**5.1.5 Налаштування зв'язку типу документа з довідником**
