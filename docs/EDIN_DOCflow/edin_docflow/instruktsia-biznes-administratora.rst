...
13 Групи
---------
Групи користувачів необхідні для налаштування процесу узгодження. Інформація за групами користувачів доступна в розділі «Керування доступом» - «Погодження групою», де відображаються всі створені групи із можливістю фільтрації за компанією.
...
15 Аналітика
------------
Розділ у якому можливо створити звіт про документообіг відображається тільки користувачам з ввімкненими ролями на даний розділ (меню "Управління доступом" → "Ролі" → "Розділи"). Розділ дозволяє "Створити звіт" по зовнішньому документообігу за обраний період часу по одній з "своїх" компаній (можливо вибрати контрагента). 
...
Вибірка формується за **датою відправлення документу** (а не створення), тобто для документів які вже не у статусі Чернетка. 
