...
------------------------
Доступ до комплектів визначає перелік контрактів і комплектів, до яких буде надано доступ користувачеві. Сценарій (чи Маршрут) є прикріпленим до компанії.

Для налаштування маршруту перейдіть у розділ «Налаштування узгодження» – «Доступ до комплектів». У розділі відображаються всі створені сценарії доступів клієнтів. Для зручності реалізовано фільтр пошуку сценаріїв за компанією, до якої прикріплений маршрут, за статусом (активний / заблокований), за назвою маршруту:

.. image:: pics_instruktsia-biznes-administratora/biznes-administratora_foto_7_01.png
   :align: center
...
Після збереження даних з’явиться можливість працювати з вкладками «Користувачі», «Контракти» та «Типи комплектів» для остаточного налаштування доступу:
...
.. image:: pics_instruktsia-biznes-administratora/biznes-administratora_foto_7_03.png
   :align: center
