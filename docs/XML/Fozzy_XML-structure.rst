XML Специфікації для роботи з Фоззі
####################################
...
.. _Інструкцією по роботі з мережею Фоззі за схемою «Match Invoice»: https://wiki.edi-n.com/uk/latest/retail_2.0/Robota_s_Fozzy_EDI-N_2.0.html
