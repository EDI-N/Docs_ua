...
Для детальної інформації ознайомтесь з `Інструкцією по роботі з мережею Фоззі`_ та `Інструкцією по роботі з "Накладною за кількістю" <https://wiki.edin.ua/uk/latest/retail_2.0/Fozzy_DOCUMENTINVOICE_instruction.html>`_ за схемою **"Match Invoice"**.
...
.. csv-table:: Накладна за кількістю (DOCUMENTINVOICE)
  :file: Fozzy_XML/DOCUMENTINVOICE.csv
  :widths:  40, 7, 12, 41
  :header-rows: 1

:download:`Приклад DOCUMENTINVOICE<examples/DOCUMENTINVOICE_example_f.xml>`
