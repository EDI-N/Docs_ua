...
Для детальної інформації ознайомтесь з `Інструкцією по роботі з мережею Фоззі <https://wiki.edin.ua/uk/latest/retail_2.0/Robota_s_Fozzy_EDI-N_2.0.html>`_ та `Інструкцією по роботі з "Накладною за кількістю" <https://wiki.edin.ua/uk/latest/retail_2.0/Fozzy_DOCUMENTINVOICE_instruction.html>`_ за схемою **"Match Invoice"**.
