...
:green:`Особистий кабінет. Контрагенти`
    #. **Можливість відправити Комерційну пропозицію**
        Цінність: Крім заявок на підключення до Торгової Мережі та заявок на факторинг, до меню «Контрагенти» додано можливість створити та відправити Комерційну пропозицію.  Відтепер дане маню є точкою взаємодії з контрагентами по різним питанням та направленням.
