...
.. toggle-header::
    ...
    :green:`Комерційні пропозиції`
        #. **Акція "Доступ без обмежень"**
            Цінність: З 1 листопада по 30 червня 2022 року для всіх користувачів платформи діє безкоштовний доступ без обмежень на тариф "Комерційні пропозиції для мереж"! Підключитися до сервісу можливо за `посиланням <https://edo-v2.edin.ua/app/#/service/novelty/novelties>`__.
