...
Сформований фільтацією список можливо **"Завантажити"** на свій носій в csv форматі.
...
Для сервісу "Вільний" також модливо налаштувати Аліаси (додаткові email адреси, на які можуть приходити документи в сервіс "Вільний"):
...
До цієї компанії можливо **"Додати співробітника"** зі списку користувачів або додати дані нового спіробітника (**"Створити співробітника"**). Також можливо **"Додати"** адреси компанії, створити `правила тарифікації <https://wiki.edin.ua/uk/latest/ETTN_2_0/Create_act_at_accepted_work.html#additional-functionality>`__ (для сервісу **"Е-ТТН"**) та ввести ідентифікатори:   
...
.. image:: pics_PCInstruction/PCInstruction_99.png
   :align: center
...
Список можливо відсортувати за статусом підключення (:orange:`Не підключено`, :green:`Підключено`), виконати пошук за частиною назви чи GLN:

.. image:: pics_PCInstruction/PCInstruction_97.png
   :align: center

В списку відображається назва мережі, логотип, GLN, додаткова інформація, статус підключення та кнопка **"Підключити"** (формування запиту на підключення):

.. image:: pics_PCInstruction/PCInstruction_89.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_140.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_125.png
   :align: center
...
Відправлений запит змінює свій статус на :orange:`На розгляді` і відображається в **"Запитах"**:

.. image:: pics_PCInstruction/PCInstruction_94.png
   :align: center
...
Список можливо відсортувати за статусом запиту, виконати пошук за частиною назви/імені, GLN, номером чи датою договору та іншою інформацією в запиті (№ телефону, e-mail, ЄДРПОУ, ІПН):

.. image:: pics_PCInstruction/PCInstruction_98.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_90.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_104.png
   :align: center

**3.1.3.2 Для Мережі:**
""""""""""""""""""""""""""""""""""""""""""""""""""""""

**Запити** - підрозділ всіх отриманих в мережу запитів. В списку відображається ім'я особи-підписанта, логотип, GLN, додаткова інформація, договір підключення, статус заявки. Детальніше ознайомитись з запитом на підключення можливо клікнувши на ПІБ відправника запиту:

.. image:: pics_PCInstruction/PCInstruction_95.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_96.png
   :align: center
