...
Перейти в розділ можливо з меню особистого кабінету (для користувача, підя яким Ви авторизувались) чи при редагуванні користувача компанії (для адміністраторів акаунта (`"Ролі користувачів" <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#user-roles>`__)):
