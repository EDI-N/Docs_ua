...
.. important::
   Введені дані адреси (Індекс, Країна, Область, Місто (населений пункт), Вулиця) в подальшому автоматично вказуються при створенні комерційних документів на https://edo-v2.edin.ua і повинні співпадати з даними в Єдиному реєстрі!
...
.. image:: pics_PCInstruction/PCInstruction_243.png
   :align: center
