...
Розділ **Сервісів** дозволяє користувачу налаштувати та покращити взаємодію з сервісами платформи та контрагентами.
...
**Постачальники** - підрозділ зі списком підключених до платформи Постачальників - вказується назва компанії, логотип, GLN, ЄДРПОУ, ІПН, за якими і можливо відсортувати список:
...
Після підписання сформований запит (чернетка) готовий до відправки в мережу (кнопка **"Відправити запит"**):

.. image:: pics_PCInstruction/PCInstruction_93.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_91.png
   :align: center
