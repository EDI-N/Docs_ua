...
.. hint::
        Для доступних для покупки тарифних пакетів, а також при "Зміні" активного тприфного пакету можливо проставити відмітку "Пролонгація", що на початку місяця (1 числа) автоматично продовжує дію обраного тарифного пакету/кількості доступів по сервісу на 1 місяць (за умови, що на балансі достатньо коштів). 
