...
.. image:: pics_New_balance_tariff/New_balance_tariff_121.png
   :align: center
...
.. image:: pics_New_balance_tariff/New_balance_tariff_122.png
   :align: center
...
.. удалить потом, когда Таня окнет компактную версию
   розділ **"Купівлі"** і в категорії **"Інтеграція"** натиснути **"Придбати"** доступний спец тариф:
   ...
   У вікні автоматично відобразиться вартість ліцензії в залежності від обраних параметрів та діючих акційних знижок на момент придбання. Обрану ліцензію можливо додати до кошика (кнопки **"Додати у кошик і продовжити покупки"** чи **"Додати і перейти до кошика"**):

   .. image:: pics_New_balance_tariff/New_balance_tariff_21.png
      :align: center

   Після чого в розділі меню **"Кошик"** додається помітка з кількістю обраних сервісів/послуг, а в правому верхньому куті відображається загальна їх вартість. В розділі **"Купівля"** додані до **"Кошика"** ліцензії мають відповідну помітку і їх можливо вилучити з корзини (кнопка **"Видалити"**):
...
.. attention::
   У компанії, що є платником НДС і працює з ЮЗД, згідно законодавства, поле "Код ознаки джерела податкового номера" повинно бути заповним (платформа підкаже про це модальним вікном з посиланням до налаштувань GLN, через який здійснюється обмін документами з АТС `"Документи" <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#docs>`__).
...
Після підписання сформований запит (чернетка) можливо **"Відправити запит"** в мережу (також можливо **"Завантажити PDF заявки"**):

.. image:: pics_PCInstruction/PCInstruction_103.png
   :align: center
