...
В "Додаткових налаштуваннях" (при створенні чи редагуванні користувача) у **Супер адміністратора** чи **Адміністратора** є можливість увімкнути/вимкнути повідомлення від платформи EDIN чи налаштувати повідомлення для роботи з конкретним типом документів. 
