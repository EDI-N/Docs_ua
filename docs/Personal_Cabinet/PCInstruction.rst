...
В викикаючому pop-up вікні потрібно обрати **Тип контакту** з випадаючого списку (фінансові питання / комерційні питання / технічні питання / дирекція), вказати ПІБ контакту (ввести вручну та **"Застосувати введене значення"** чи обрати зі списку `користувачів <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#users>`__ (працює пошук)), мобільний номер телефону та **"Зберегти"** контакт.
