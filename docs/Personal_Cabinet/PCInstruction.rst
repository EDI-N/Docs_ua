...
На вкладці представлені дані по балансу користувача, історія балансу, функціонал для його поповнення, активні/замовлені/доступні тарифні пакети. Користувачу доступна **"Історія здійснених операцій"**:
...
.. attention::
   При **"Зміні"** тарифу (розширенні) встроєним в web функціоналом відбувається автоматичне списання коштів з балансу (подробиці в "Історії операцій"), однак якщо суми для автоматичної **"Зміни"** не достатньо, то буде створено рахунок у вкладці `"Документи" <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#docs>`__.
...
**Доступні для придбання тарифні пакети та сервіси**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
**Тарифні пакети, які очікують оплати**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
**Ролі користувачів:**
   ...
   * **Супер адміністратор** - необмежений доступ до сервісів та налаштувань. Присвоюється при при `реєстрації на платформі <https://wiki.edin.ua/uk/latest/general_2_0/User_registration.html>`__) і не може бути змінена від імені цього користувача.
   * **Адміністратор** - необмежений доступ, окрім розділу "`Аккаунт`_".
   * **Бухгалтер (Фінансист)** - необмежений доступ до налаштувань та лише обраних зі списку сервісів (невідмічені сервіси у користувача не відображаються).
