...
.. note::
   Сервісна підтримка **"Стандарт"** вже доступна всім користувачам платформи.
...
Розділ **"Очікують оплати"** містить неоплачені послуги/ліцензії і дозволяє переглянути/скачати створений рахунок-договір (кнопка **"Рахунок"**) для подальшої оплати через банківські установи чи **"Видалити"** позицію.
