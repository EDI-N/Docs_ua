...
**2.4.1.2 Договори (GLN)**
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

Довідник договорів доступний для ролей **Супер адміністратора** / **Адміністратора** при наявності трафіку документообігу з мережами. Створені договори використовуються для автоматичного заповнення полів в EDI сервісі. **"+Створити договір"** можливо за допомогою відповідної кнопки:
...
Створені договори можливо редагувати (клік на назву договору) та видаляти (|delete2|):
...
.. _agreements-catalogue: 

**3.2 Довідник для Договорів**
----------------------------------

**"Довідник для Договорів"** дозволяє створювати, редагувати та шукати договори, що вже можуть бути додані, якщо їх дані були вказані при обміні документами з Вашими контрагентами:
...
**3.2.1 Наповнення Довідника для Договорів**
````````````````````````````````````````````````````
...
При створенні договору відкривається форма (поля обов'язкові до заповнення позначені червоною зірочкою :red:`*`). Після того, як обов'язкові поля заповнені можливо **"Створити договір"**.

Відредагувати створений договір можливо натиснувши на Номер договору (внесені зміни потрібно **"Зберегти"**), а видалити за допомогою кнопки  |delete3| :
