...
Розділ **"Аккаунт"** - це розділ Особистого кабінету клієнта, який призначено для взаємодії з провайдером, отримання та підписання документів від провайдера, керування Особовим рахунком (Балансом), вибір, зміна та налаштування тарифних пакетів. Підрозділ **"Аккаунт"** містить дві основні вкладки: **"Баланс"** та **"Документи"**. 
