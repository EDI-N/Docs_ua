...
В налаштуваннях **"GLN"** відображаються дані (Номер, Назва, Місто, Вулиця) по всім доданим GLN-ам, присутня можливість редагувати/видалити існуючі GLN (клік мишкою на номер GLN) та додати до платфоми нові GLN:
...
.. important::
   При **"Cтворенні GLN"** з незаповненим полем "GLN" його значення автоматично генерується платформою EDIN 2.0. Номер GLN на відміну від решти даних неможливо відредагувати (лише додати та видалити).
...
.. image:: pics_PCInstruction/PCInstruction_24.png
   :align: center

.. image:: pics_PCInstruction/PCInstruction_25.png
   :align: center
...
.. image:: pics_PCInstruction/PCInstruction_26.png
   :align: center
