...
.. note::
   ...
   Якщо ТТН формується не від імені **Вантажовідправника** (в полі зазначений учасник документообігу, відмінний від поточного), то даний документ буде відправлений лише **Вантажовідправнику** до ознайомлення, як "Попередня ТТН" (такий документ не потребує підписання):
...
.. image:: pics_Create_ETTN/Create_ETTN_017.png
   :align: center
...
.. image:: pics_Create_ETTN/Create_ETTN_047.png
   :align: center
...
.. note::
   Якщо ж документ створювався іншим учасником документообігу, то після відправки документ ідображається в журналі надісланих документів в статусі :orange:`"Попередня ТТН"`:
...
.. image:: pics_Create_ETTN/Create_ETTN_046.png
   :align: center
