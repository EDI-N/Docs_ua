...
.. image:: pics_Create_ETTN/Create_ETTN_001.png
   :align: center

Після чого відкривається готова до заповнення порожня форма "е-ТТН" документа:

.. image:: pics_Create_ETTN/Create_ETTN_002.png
   :align: center
...
Для наповнення **"Відомостей про вантаж"** потрібно натиснути на кнопку **"+Додати"** та заповнити відповідні поля в модальному вікні (поля обов'язкові до заповнення позначені червоною зірочкою :red:`*`):

.. image:: pics_Create_ETTN/Create_ETTN_023.png
   :align: center
...
.. image:: pics_Create_ETTN/Create_ETTN_036.png
   :align: center
...
.. image:: pics_Create_ETTN/Create_ETTN_043.png
   :align: center
...
Після відправки "е-ТТН" **Вантажовідправником** документ відображається в журналі надісланих документів в статусі :orange:`"Очікує підписання водієм"`:

.. image:: pics_Create_ETTN/Create_ETTN_045.png
   :align: center
...
.. image:: pics_Create_ETTN/Create_ETTN_056.png
   :align: center

За потреби документ можливо **"Відхилити"** (`детальніше <https://wiki.edin.ua/uk/latest/ETTN_3_0/ETTN_Reject.html>`__). Можливо скористатись функціоналом **"Клонування"** - створення нового "е-ТТН" документа, що автоматично заповнюється даними з уже відправленого документа. Також можливо **"Завантажити"** створену "е-ТТН", обравши один з доступних форматів (.pdf / .xml / .xls / .zip).
...
При цьому при виникненні помилки з вкладенням його можливо спробувати перевідправити за допомогою кнопки |rotate| чи видалити.

Будь-який учасник документообігу завжди має можливість **"Додати файл"** супровідного документа (без можливості його видалити)! Однак, якщо при додаванні файлу є відмітка про додавання цих даних в форму документа, то такі дії прирівнюються до внесення змін в документ і потребують перепідписання:

.. image:: pics_Create_ETTN/Create_ETTN_058.png
   :align: center

Також можливо відмінити зміни в документ кнопкою **"Очистити"**.
