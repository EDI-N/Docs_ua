...
.. note::
   ...
   **Ширина**
   * якщо у всіх ТЗ вказана ширирна - використовується максимальна з них;
   ...
   **Маса**
   * якщо у всіх ТЗ вказана висота - обчислюється за формулою: 
     Загальна маса з вантажем = сума мас усіх ТЗ + маса вантажу (з табличної частини документа).
