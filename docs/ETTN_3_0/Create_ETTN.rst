...
Внесення даних можливо **"Скасувати"**, а вже введені дані можливо редагувати (|pencil|) чи видалити за потреби (|x|). Після того, як всі обов'язкові поля форми будуть заповнені їх можливо **"Додати"**.
