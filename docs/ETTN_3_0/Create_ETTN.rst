...
Для розрахунку значень натисніть кнопку **"Розрахувати"**.
  
.. note::
   Вимоги та як працює автоматичний розрахунок детально описано за `посиланням <https://wiki.edin.ua/uk/latest/ETTN_3_0/What_work_calculation.html>`__
...
**1.1.3 Відомості про тару**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Для додавання відомостей про тару потрібно натиснути кнопку **"Додати"** та заповнити відповідні поля в модальному вікні (поля, обов'язкові до заповнення, позначені червоною зірочкою :red:`*`), а саме **"Тип тари"** та **"Завантажена кількість"**.

.. image:: pics_Create_ETTN/Create_ETTN_079.png
   :align: center
   :width: 80%
   
.. note::
   У випадку відсутності необхідного типу тари потрібно натиснути кнопку **"Додати новий тип тари"** та внести його в довідник заповнивши поле **"Новий тип тари"**. Після додавання новий тип тари буде доступний для вибору зі списку в полі **"Тип тари"**.

   .. image:: pics_Create_ETTN/Create_ETTN_080.png
      :align: center
      :width: 50%

За необхідністю є можливість додавати ще тару, для цього необхідно натиснути на кнопку **"Додати"** та заповнити інформацію в модальному вікні.

Для редагування інформації щодо тари необхідно навести курсор на рядок цієї тари та натиснути **"Змінити"**, для видалення – **"Видалити"**:

.. image:: pics_Create_ETTN/Create_ETTN_081.png
   :align: center
   :width: 80%

.. note::
   Поля **"Розвантажена кількість"** та **"Вид тари"** заповнюються Вантажоодержувачем. Також він має можливість додати новий рядок та внести відомості про тару, заповнивши поля: **"Тип тари"**, **"Розвантажена кількість"** та **"Вид тари"**.

**1.1.4 Додаткові дані**
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
