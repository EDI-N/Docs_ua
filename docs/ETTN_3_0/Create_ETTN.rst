...
За потреби додати ще тару, необхідно натиснути на кнопку **"Додати"** та заповнити інформацію в модальному вікні.
...
.. note::
   Поля **"Розвантажена кількість"** та **"Вид тари"** заповнюються Вантажоодержувачем. 
   Також він має можливість додати новий рядок та внести відомості про тару, заповнивши поля: **"Тип тари"**, **"Розвантажена кількість"** та **"Вид тари"** у модальному вікні.
