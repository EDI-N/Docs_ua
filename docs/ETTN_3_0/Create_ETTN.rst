Створення та відправка "е-ТТН" (ініціатор: Вантажовідправник)
###################################################################################################
...
.. note::
   Дані **Вантажовідправника** - це дані Вашої компанії, що заповнюються автоматично і недоступні до редагування:

   .. image:: pics_Create_ETTN/Create_ETTN_011.png
      :align: center
