...
Автоматично визначається Ваша роль документообігу. Для різних ролей існує свій набір полів. Можливо обрати поле та ввести відповідне значення. Такі додаткові поля не можуть повторюватись на рівні одного документа.
