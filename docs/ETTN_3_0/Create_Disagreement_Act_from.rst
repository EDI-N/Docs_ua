...
Для того аби створити "Акт розбіжностей про вантаж" **"Вантажоодержувачу"** потрібно перейти до каталогу **"Вхідні"** (1) та обрати потрібний е-ТТН документ в статусі "Очікує підписання вантажоодержувачем":
...
.. image:: pics_Create_Disagreement_Act_from/Create_Disagreement_Act_from_005.png
   :align: center
