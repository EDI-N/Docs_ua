...
Ініціатором відхилення "е-ТТН" може виступати **"Вантажовідправник"** (відправник документа) та **"Водій" / "Перевізник"** (учасник документообігу в схемі :green:`"Вантажовідправник" -> "Перевізник" -> "Вантажоотримувач"`). Відхилити "е-ТТН" можливо поки документ перебуває в статусі :orange:`"Очікує підписання водієм"` тобто поки **"Водій" / "Перевізник"** не підписав документ.
