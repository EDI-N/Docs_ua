...
"Акт примусового завершення" складається **Замовником** (роль учасника документообігу) у разі неможливості завершення життєвого циклу "е-ТТН". Документ "Акт примусового завершення" створюється на підставі "е-ТТН", що вже підписаний **Перевізником** (документ має статус :orange:`"Очікує підписання вантажоодержувачем"`)

.. hint::
   Також "Акт примусового завершення" можливо створити на підставі "е-ТТН" коли вантаж розвантажено та отримувач підписав «Акт завантаження на проміжному складі».

Документообіг "Актом примусового завершення" здійснюється між **Замовником** та **Перевізником**. При формуванні "Акта примусового завершення" ініціатором документа виступає **Замовник**. Обмін документом здійснюється між учасниками в наступному порядку: 
...
В документі також обов'язково зазначається відповідальна/-ні особи **"Замовника"** за допомогою кнопки **"+Додати"**. Дані раніше доданих відповідальних осіб можливо обрати з віртуального довідника:
