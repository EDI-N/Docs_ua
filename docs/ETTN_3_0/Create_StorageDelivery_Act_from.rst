...
.. important::
   ТТН та коригуючі акти до неї є частиною процесу перевезення. Вони фіксують усі зміни, пов’язані з перевантаженням, перепломбуванням, зміною пункту призначення та іншими коригуваннями. 
   Після завершення життєвого циклу акта він стає доступним усім учасникам, зазначеним у ТТН, і забезпечує прозорість процесу перевезення.
