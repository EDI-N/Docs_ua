...
Ініціатором відхилення "Акта розбіжностей про вантаж" може виступати **"Вантажоодержувач"** (відправник документа) та **"Перевізник"** (отримувач документа). Відхилити "Заявку на транспортування" можливо поки документ перебуває в статусі :orange:`"Очікує підписання перевізником/водієм"` тобто поки **"Перевізник"** не підписав документ.
