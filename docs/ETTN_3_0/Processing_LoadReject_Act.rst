...
Після ознайомлення з документом Ви можете **Прийняти** чи `"Відхилити" <https://wiki.edin.ua/uk/latest/ETTN_3_0/Adjustment_Act_Reject.html>`__ "Акт про відмову вантажити". Для того, щоб **Прийняти** документ обов'язково потрібно **"+Додати"** дані відповідальної особи в табличній частині блоку **"Відповідальні особи"** в нижній частині документа:
