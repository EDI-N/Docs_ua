...
Документ "Акт виконаних робіт (Логістика)" (COMDOC_037) можливо створити за двох умов:

   * "Заявка на транспортування" (TRANSPORTATIONORDER з SUBDOCTYPE = 1) або "Підтвердження заявки на транспортування" (TRANSPORTATIONORDER з SUBDOCTYPE = 2) :underline:`підписана контрагентами (з обох сторін)`;
   * пов'язана "е-ТТН" :underline:`підписана контрагентами (з трьох сторін)` (документ перебуває в статусі :green:`"Підписано вантажоодержувачем"`).
...
**1 Створення "Акта виконаних робіт (Логістика)" на підставі "Заявки на транспортування" / "Підтвердження заявки на транспортування" / "е-ТТН"**
===========================================================================================================================================
...
.. note::
   Якщо в ланцюжку поставки (ланцюжку з документом-підставою) знаходився "Акт перевантаження" (ReloadAct) то при формуванні "Акта виконаних робіт (Логістика)" :underline:`дані про Транспорт та Водія` атоматично доповнюються (додаються без дублів) в табличну частину документа:
...
.. note::
   ...
   .. attention::
      Для **Замовника** ПрАТ «Монделіс Україна» документ "Акта виконаних робіт (Логістика)" при створенні додатково має контрольну перевірку загальної вартості послуг з ПДВ:
