...
**"Перевізнику, що здає вантаж"** для створення **"Акта перевантаження"** в сервісі "EDI+ЮЗД" потрібно перейти у **"Вхідні"** та перейти в "Товарно-транспортну накладну", до якої потібно створити коригуючий акт ("е-ТТН" в статусі :orange:`"Очікує підписання вантажоодержувачем"`):
