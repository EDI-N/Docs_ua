...
Для створення "Заявки на транспортування" в сервісі **"EDI Network"** **"Замовнику"** необхідно виконати наступні дії: 

1. Натисніть на кнопку **"Створити"**.
2. У модальному вікні **"Створити документ"** оберіть документ **"Заявка на транспортування"** (за необхідністю скористатись рядком пошуку).
...
- **"Автомобільний перевізник"** - натисніть на кнопку **"Пошук перевізника"** (|лупа|) (Покажчик 3). Після цього відкриється модальне вікно **"Пошук перевізника"**,
  у якому в рядку пошуку виконайте пошук контрагента за назвою компанії / GLN / ІПН (Покажчик 4). Для підтвердження вибору натисніть кнопку **"Вибрати"** (Покажчик 5). 
...
у якому  заповніть поля: **"Реєстраційний номер"**, **"Марка"**, **"Модель"**, **"Тип"**, **"Колір"**, **"Довжина, мм"**, **"Ширина, мм"**, **"Висота"**, **"Загальна вага без вантажу"**.
...
Після вибору транспортного засобу в полі **"Автомобіль"** з’явиться додатковий функціонал для подальших дій: вибору іншого авто, редагування даних транспортного засобу
або очищення поля (Покажчик 10).
...
"Температурний режим" - вкажіть мінімальний та максимальний температурний режим (Покажчик 12).
...
Для збереження даних натисніть на кнопку **"Додати"** (Покажчик 13).
...
Після вибору транспортного засобу в полі **"Причіп/напівпричіп"** з’явиться додатковий функціонал для подальших дій: вибору іншого авто, редагування даних транспортного засобу або очищення поля (Покажчик 14).

Після натискання на кнопку:
   * **"Обрати"** - поле стане активним для вибору нового значення. Якщо нове значення не буде вибрано, у полі відображатиметься попереднє.
   * **"Змінити"** - відкриється вікно **"Редагування даних причепа / напівпричепа"**, у якому можна змінити дані обраного транспортного засобу. Для збереження внесених змін, натисніть на кнопку **"Редагувати"** (Покажчик 15);
   * **"Очистити"** - поле буде очищене від обраного значення. 

"Температурний режим" - вкажіть мінімальний та максимальний температурний режим (Покажчик 16).

.. note::
   У разі наявності двох причепів або напівпричепів заповніть ще одне поле (Покажчик 17).
...
.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_007_v2.png
   ...
   * **"Відомості про транспортний засіб без урахування вантажу"** - 
  
   * **"Водій"** - 

- **"Вантажовідправник"** - поле заповнюється 




Заповнити дані  (обов'язково) та  (опціонально) можливо за допомогою кнопки **"Пошук контрагента"** (|лупа|) або ж за допомогою кнопки **"Вказати себе"** (|будинок|):
