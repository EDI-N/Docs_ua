...
.. |lupa| image:: /_constant/icons/lupa.png
...
.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_016_v2.png
   :align: center
   :width: 80%

.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_017_v2.png
   :align: center
   :width: 80%
...
Для заповнення табличної частини документа потрібно натиснути на кнопку **"+ Додати"** (Покажчик 43). Після цього відкриється модальне вікно **"Інформація про маршрут і вантаж"**, у якому заповніть поля:

**"Навантаження"**
* **"Адреса"** - почніть вводити адресу вантажовідправника. Пошук активується після введення трьох символів. Після цього оберіть пункт навантаження зі списку (Покажчик 44). Для очищення поля натисніть на кнопку (|lupa|), яка з'явиться в полі після обраного значення (Покажчик 45).
* **"Дата"** - натисніть на поле, після чого в календарі оберіть дату та встановіть час завантаження вантажу (Покажчик 46). Для підтвердження даних натисніть кнопку **"Обрати"** (Покажчик 47). Для очищення поля натисніть кнопку (|delete|) (Покажчик 48);

.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_013_v2.png
   :align: center
   :width: 80%

* **"Відповідальна особа"** - почніть вводити дані контактної особи. Пошук активується після введення трьох символів. Після цього оберіть відповідальну особу зі списку довідника (Покажчик 49).
   Для додавання контактних даних до довідника відповідальної особи натисніть кнопку **"+ Додати особу"** (Покажчик 50). Для видалення контактних даних із довідника натисніть кнопку |trash| (Покажчик 51).

.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_014_v2.png
   :align: center
   :width: 80%
   
Після натискання на кнопку **"+ Додати особу"** заповніть поля: **"ПІБ"**, **"РНОКПП"**, **"Посада"**, **"Посада"**, **"Телефон"** та **"Е-mail"**. Для збереження даних натисніть кнопку **"Додати"** (Покажчик 52), у випадку скасування дії кнопка **"Скасувати"** (Покажчик 53).

.. image:: /ETTN_3_0/pics_Create_Proposal/Create_Proposal_015_v2.png
   :align: center
   :width: 80%

Після вибору відповідальної особи в полі **"Відповідальна особа"** з’явиться додатковий функціонал для подальших дій: вибору іншої відповідальної особи, редагування даних або очищення поля (Покажчик 54).

Після натискання на кнопку:

   * **"Обрати"** - поле стане активним для вибору нового значення. Якщо нове значення не буде вибрано, у полі відображатиметься попереднє.
   * **"Змінити"** - поля: **"ПІБ"**, **"РНОКПП"**, **"Посада"**, **"Посада"**, **"Телефон"** та **"Е-mail"** стануть доступні для редагуання. Для збереження внесених змін, натисніть на кнопку **"Редагувати"**, у випадку скасування дії кнопка **"Скасувати"**.
   * **"Очистити"** - поле буде очищене від обраного значення. 

**"Розвантаження"**
* **"Вантажоодержувач"** - здійсніть пошук за назвою компанії / GLN / назвою контрагента та оберіть зі списку необхідне значення (Покажчик 55). Для очищення поля натисніть на кнопку (|lupa|), яка з'явиться в полі після обраного значення (Покажчик 56);
* **"Адреса"** - почніть вводити адресу вантажоодержувача. Пошук активується після введення трьох символів. Після цього оберіть пункт вантажоодержувача зі списку (Покажчик 57). Для очищення поля натисніть на кнопку (|lupa|), яка з'явиться в полі після обраного значення (Покажчик 45).
* **"Дата"** - натисніть на поле, після чого в календарі оберіть дату та встановіть час завантаження вантажу. Для підтвердження даних натисніть кнопку **"Обрати"**. Для очищення поля натисніть кнопку (|delete|) (Покажчик 48). 
* **"Відповідальна особа"** - поле заповнюється аналогічно полю **"Відповідальна особа"** в блоці **"Навантаження"** (описано вище).

---------------------------------------

* **"Кількість місць"** - введіть 
* **"Маса брутто, кг"** - введіть 
* **"Вид транспорту"** - введіть
* **"Температурні вимоги"** - 
* **"Коментар"** - 

Для збереження введених даних натисніть на кнопку **"Додати"** (Покажичк ).
В результаті виконаних дій інформація про маршрут та вантаж буде відображатись в табличній області. 
...
Для того, щоб: 
* додати ще один запис натисніть на кнопку **"Додати"** та виповніть описані вище кроки. 
* внести зміни в існуючий запис наведіть курсор миші на необхідний запис в табличнй області на виберіть пункт **"Змінити"** у контекстному меню праворуч від запису (Пкажчик ).
* видалити запис виберіть один із способів:
   * наведіть курсор миші на необхідний запис в табличній області та виберіть пункт меню **"Видалити"** у контекстному меню праворуч від запису;
   * встановіть |square_green_tick| напроти необхідного запису (Покажчик ) та натисніть на кнопку **"Видалити"** (Покажчик ).

Для зміни послідовності записів в табличній області натисніть лівою кнопкою миші на необхідний запис в області порядкового номеру запису та перетягніть запис (Покажчик ).
