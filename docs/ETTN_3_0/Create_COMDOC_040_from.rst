...
Дана інструкція описує порядок формування та відправки документа "Рахунок (Логістика)" (COMDOC_040). Документ "Рахунок (Логістика)" (COMDOC_040) може бути створений на підставі:
...
* надісланого "Акта виконаних робіт (Логістика)" (COMDOC_037).
...
**1 Створення "Рахунку (Логістика)" на підставі "Заявки на транспортування" / "Підтвердження заявки на транспортування" / "е-ТТН" / "Акта виконаних робіт (Логістика)"**
===========================================================================================================================================
...
* :underline:`на підставі "Акта виконаних робіт (Логістика)"` потрібно перейти у **"Надіслані"** та вибрати "Акт виконаних робіт (Логістика)" (COMDOC_037) (для зручності можливо скористатись рядком пошуку):
...
.. image:: /ETTN_3_0/pics_Create_COMDOC_040_from/Create_COMDOC_040_from_003.png
   :align: center
