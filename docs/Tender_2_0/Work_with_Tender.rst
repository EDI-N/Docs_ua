...
* **Етап:** "Торги" чи "Збір пропозицій" (|рупор| / |судья|); 
...
.. attention::
   :red:`Поки тендер не розпочався Організатор може запрошувати Учасників, приймати та відхиляти (кнопками **Схвалити/Відхилити**) одну і ту ж заявку Учасника безліч разів, однак пісял того, як тендер розпочато Організатор може лише одноразово прийняти своє рішення по відношенню заявки Учасника (лише або **Схвалити** або **Відхилити**).`
