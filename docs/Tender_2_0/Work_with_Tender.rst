...
Для роботи з WEB сервісом Ви можете використовувати будь-який браузер (рекомендованим є **Google Chrome** останньої версії). Для входу до сервісу платформи необхідно перейти за посиланням: https://tender-v2.edi-n.com/ .
...
.. attention::
    Поки тендер не розпочався Організатор може запрошувати Учасників, приймати та відхиляти (кнопками **Схвалити/Відхилити**) одну і ту ж заявку Учасника безліч разів, однак пісял того, як тендер розпочато Організатор може лише одноразово прийняти своє рішення по відношенню заявки Учасника (лише або **Схвалити** або **Відхилити**).
