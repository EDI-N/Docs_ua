################################################################################################
**Створення/редагування чернетки "Акта розбіжностей про вантаж"**
################################################################################################
...
.. note::
   "Акт розбіжностей про вантаж" ствоює учасник з роллю **Вантажоотримувач** на підставі "е-ТТН" в статусі PICKUP.
