...
.. epigraph::
   ...
   Обмеження (LIMITS) на замовлення відправляється Продавцем (Виробником); в документі вказуються ціни та кількості по формуванню замовлення у вказаного Дистриб’ютора.
