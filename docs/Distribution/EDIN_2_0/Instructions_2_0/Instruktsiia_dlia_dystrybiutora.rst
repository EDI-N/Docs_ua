...
Для перегляду списку контрагентів і подальшої роботи з прайс-листами необхідно виконати вхід в систему за допомогою наданих логіна і пароля. Далі серед доступних сервісів виберіть **Дистриб'юшин**
...
Після введення замовляємої кількості по позиції, автоматично для неї розраховується:

* Загальна кіл-ть позицій в замовленні = кількість блоків в POSITION
* Загальна кіл-ть коробок = сума всіх значень BOXESCOUNT в замовленні
* Загальна кіл-ть палет = сума всіх значень PALLETS в замовленні
* Загальна вага замовлення = сума всіх значень множників WEIGHT * BOXESCOUNT в замовленні
* Сумма замовлення з ПДВ = сума всіх значень множників ORDEREDQUANTITY * PRICEWITHVAT в замовленні
* Сума замовлення без ПДВ = сума всіх значень множників ORDEREDQUANTITY * ORDERPRICE в замовленні
