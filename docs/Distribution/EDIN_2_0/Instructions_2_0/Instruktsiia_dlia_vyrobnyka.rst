...
Після відправки прайс-листа Дистиб'ютору Виробник має можливість через FTP / `API <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/API_2_0/Distribution_API_2_0_list.html>`__ відправити персональне "Попереднє замовлення" (`ORDER <https://wiki.edin.ua/uk/latest/XML/XML-structure.html#order>`__ з DOCTYPE = "PO") своєму контагенту, вказавши в ньому рекомендовані товари та їх кількості. В цьому випадку при перегляді прайс-листа Дистиб'ютором товари і кількості вже вказані і він може одразу **"+Створити замовлення"** (всі рекомендовані кількості доступні до редагування):
