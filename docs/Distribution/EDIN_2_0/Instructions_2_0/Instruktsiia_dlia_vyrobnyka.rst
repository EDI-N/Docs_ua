Створення прайс-листа. Інструкція для Продавця (Виробника)
#################################################################
...
**Маркет** — це комплексне електронне рішення, яке оптимізує процеси обміну електронними даними між Продавцями (Виробниками) та їх Покупцями (Дистриб'юторами). Інструкція описує додавання та редагування прайс-листа, обмежень та квот, перегляд списку дистрибʼюторів та замовлень. 
...
Після вибору сервісу за замовчуванням відобразиться розділ з Вашими Покупцями (Дистриб'юторами). В журналі відображаються усі Ваші конрагенти та коротка інформація в табличному форматі (назва, адреса, ЄДРПОУ, GLN, група (якщо є)). В розділі **"Мої покупці"** доступне сортування списка контрагентів за назвою:

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_048.png
   :align: center

В журналі одразу зрозуміло в яких Покупців немає "Прайс-листа" / "Обмежень" - за допомогою кнопки **"Переглянути"** відкривається модальне вікно встановлених "Обмежень" чи здійснюється перехід в "Прайс-лист" обраного контрагента; за допомогою кнопки **"Завантажити"** здійснюється перехід в розділ **Масового завантаження** чи додавання Обмежень в popup вікно:

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_049.png
   :align: center

Для створення прайс-листа перейдіть у розділ `Масове завантаження <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/Instructions_2_0/Instruktsiia_dlia_vyrobnyka.html#mass-downloading>`__.

За допомогою зручного рядка пошуку можливо тонко відібрати потрібних контрагентів; доступні ключі пошуку:

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_050.png
   :align: center

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_051.png
   :align: center

Доступне масове видалення прайс-листів, квот чи надбавок: для цього потрібно обрати (1) **Дистриб'ютора/-ів** та обрати, що потрібно **"Видалити"** (2):

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_047.png
   :align: center
...
Ви перейдете в "Прайс-лист" з усіма доданими позиціями:
...
, згруртованими за лінійкою продукціі та категоріями
...
Ви можете встановити |square_green_tick| чи прибрати |square_empty| відмітки для себе (Продавця) та всіх Ваших контрагентів (Покупців) для того, щоб відображати чи приховувати відповідно ці поля при перегляді "Прайс-листа" (обов'язкові поля не доступні до змін відображення |square_grey_tick| - вони завжди відображаються). Перші поля в списку закріплені й відображаються саме в такому порядку, однак інші поля, що мають символ |drag_dots| перед назвою можливо перетягувати між собою лівою кнопкою миші, змінюючи таки чином порядок відображення колонок при перегляді "Прайс-листа":
...
Якщо Ви плануєте Додати процеси: "Рекомендації до замовлення", "Контроль кратності палет + надбавка", то маєте передбачити, що це впливає на обов'язкове відображення деяких полів "Прайс-листа" (є підказки про поля, що залучені в обраний процес):
...
Для перегляду Обмежень (`Додавання обмежень <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/Instructions_2_0/Instruktsiia_dlia_vyrobnyka.html#limits-add>`__), в розділі **Мої покупці** натисніть на кнопку **"Переглянути"** чи **"Завантажити"** в колонці **Обмеження** навпроти потрібного контрагента:

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_053.png
   :align: center
...
.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_054.png
   :align: center
...
**2.4 Попереднє замовлення (рекомендації для Дистиб'ютора (Покупця))**
-------------------------------------------------------------------------------
