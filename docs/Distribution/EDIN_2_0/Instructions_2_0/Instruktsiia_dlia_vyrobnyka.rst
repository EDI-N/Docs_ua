...
За допомогою кнопки **"Видалити"** можливо повністю видалити прайс-лист (1), всі квоти для цього прайс-листа (2), всі надбавки для цього прайс-листа (3) для данного дистриб'ютора; також доступне видалення конкретної позиції (кнопка |trash_f_red|):
...
* **Контроль кратності палет + надбавка** - процес ToDo
...
Для оптимізації роботи з великою кількістю контрагентів передбачена можливість об'єднання дистриб'юторів в групи. В розділі "Управління групами" **Продавець (Виробник)** може "Створити групу" відповідною кнопкою, дати назву новій групі в спливаючому вікні та натиснувши "Зберегти":
...
1) ORDERS (дистриб'ютор) -> ORDRSP (Продавець (Виробник)) -> DESADV (Продавець (Виробник)) -> RECADV (дистриб'ютор) -> INVOICE (Продавець (Виробник))
2) ORDERS (дистриб'ютор) -> ORDRSP (Продавець (Виробник)) -> DESADV (Продавець (Виробник)) -> COMDOC_006 (Продавець (Виробник))
3) ORDERS (дистриб'ютор) -> ORDRSP (Продавець (Виробник)) -> INVOICE (Продавець (Виробник))
4) ORDERS (дистриб'ютор) -> ORDRSP (Продавець (Виробник)) -> COMDOC_006 (Продавець (Виробник))
5) ORDERS (дистриб'ютор) -> ORDRSP (Продавець (Виробник)) -> RECADV (дистриб'ютор) -> INVOICE (Продавець (Виробник))
6) ORDERS (дистриб'ютор) -> DESADV (Продавець (Виробник)) -> RECADV (дистриб'ютор) -> INVOICE (Продавець (Виробник))
7) ORDERS (дистриб'ютор) -> DESADV (Продавець (Виробник)) -> COMDOC_006 (Продавець (Виробник))
8) ORDERS (дистриб'ютор) -> INVOICE (Продавець (Виробник))
9) ORDERS (дистриб'ютор) -> COMDOC_006 (Продавець (Виробник))
