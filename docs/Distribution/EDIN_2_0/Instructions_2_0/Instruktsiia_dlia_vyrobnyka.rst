...
**Дистриб'юшн** — це комплексне електронне рішення, яке оптимізовує процеси взаємообміну е-даними між виробниками та їх дистриб'юторами. Інструкція описує додавання та редагування прайс-листа, обмежень та квот, перегляд списку дистрибʼюторів та замовлень. 
