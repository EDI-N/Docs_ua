...
Доступне масове видалення прайс-листів, квот чи надбавок: для цього потрібно обрати (1) **Покупця/-ів (Дистрибʼютора/-ів)** та обрати, що потрібно **"Видалити"** (2):
...
**8 Відправлення прайс-листів Покупцям (Дистриб'юторам) з облікової системи**
==============================================================================
