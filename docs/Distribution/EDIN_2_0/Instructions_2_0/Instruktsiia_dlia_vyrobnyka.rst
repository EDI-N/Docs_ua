...
.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_21.png
   :align: center

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_22.png
   :align: center

У цьому вікні ви можете редагувати дані позицій, або назву категорій - для цього натисніть на **назву товарної позиції**. Відкриється модальне вікно з Даними позиції - поля відмічені червоною зірочкою :red:`*` **обовязкові до заповнення**!

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_18.png
   :align: center

Також тут ви можете повністю видалити прайс-лист для данного дистриб'ютора натиснувши **Очистити прайс-лист** або видалити якусь конкретну позицію (кнопка |смітник|).
...
Для перегляду Обмежень, на сторінці контрагентів натисніть на колонку **Обмеження** навпроти потрібного контрагента.

.. image:: pics_dlia_vyrobnyka/Instruktsiia_dlia_vyrobnyka_23.png
   :align: center

Відкриється сторінка зі встановленими обмеженнями, які ви можете редагувати або видалити усі обмеження для цього дистриб'ютора.
...
Також в розділі на сторінці представлена **Інструкція** з правилами щодо заповнення форм для **Прайс-листа** / **Обмежень** / **Квот**. 
...
Користувачу доступна робота з наступними EDI документами:
