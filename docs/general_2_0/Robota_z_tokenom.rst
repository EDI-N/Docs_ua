...
c) Встановлена на комп'ютері web-бібліотека підпису користувача ЦСК повинна бути запущена:
...
e) Виберіть мишкою токен, ведіть пароль для ініціалізації КЕП та натисніть **"Додати"**: 
...
.. image:: pics_Robota_z_tokenom/Robota_z_tokenom_29.png
   :align: center
