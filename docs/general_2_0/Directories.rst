...
Поля "Тип сертифіката" та "Вид сертифіката" обираються зі списку. Після того, як всі обов'язкові поля будуть заповнені можливо продовжити **"Далі"**:
...
Після того, як вкладення будуть додані Ви зможете **"Зберегти"** сертифікат в чернетках (сертифікат буде відображатись в розділі **"Чернетки"**) або продовжити створення натиснувши кнопку **"Далі"**. Також можливо перейти до **"Пов'язаних товарів"**, обравши категорію в **картці сертифіката**:
