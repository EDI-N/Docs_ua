...
.. |non| image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_04n.png
...
Після успішної авторизації відкриється основне меню для вибору сервісу платформи EDIN: **"Вільний", "EDI+ЮЗД", "Е-ТТН", "Виробник", "Дистриб'ютор", "Е-Сертифікати", "Е-Специфікація", "Комерційні пропозиції", "Тендер", "Товари", "DOCflow", "Wiki"**. 
...
.. image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_08n.png
   :align: center

.. image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_09n.png
   :align: center
