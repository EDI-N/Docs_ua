...
**9.2 Розширені можливості параметрів пошуку**
---------------------------------------------------------
...
**9.2.1** **Номер** — пошук документа за номером:
...
**9.2.2** **Дата** — пошук документа за датою документа (створення) / доставки / отримання:
...
**9.2.3** **GLN** — пошук документа за GLN:
...
**9.2.4** **Мережа** — пошук документа за назвою мережі:
