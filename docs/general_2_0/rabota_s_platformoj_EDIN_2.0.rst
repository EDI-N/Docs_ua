...
Щоб **Запустити раніше створений сценарій**, потрібно в модальному вікні обрати сценарій (Ви можете переглянути всі кроки обраного сценарію) та **"Запустити погодження"**:

.. image:: /general_2_0/pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_078.png
   :align: center

Щоб **Створити та одразу запустити створений сценарій погодження**, потрібно в модальному вікні натиснути на **"Налаштувати новий сценарій"**:

.. image:: /general_2_0/pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_077.png
   :align: center

Далі в модальному вікні налаштувань нового сценарію вказати його назву, обрати `варіант дій при відхиленні <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#doc-approval-set>`__ , обрати зі списку відповідальних за крок погодження користувачів (`Пов'язані користувачі <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#gln-user>`__ з GLN), обрати роль (**Погодити** крок погодження без підписання документа чи **Підписати** документ для продовження/завершення погодження). За необхідності додати додатковий крок погодження за допомогою натискання кнопки "**+**":

.. image:: /general_2_0/pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_054.gif
   :align: center

Після закінчення налаштувань натисніть кнопку "**Запустити погодження**".
