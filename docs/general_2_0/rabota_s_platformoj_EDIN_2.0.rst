...
.. image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_040.png
   :align: center
...
#. "Погодження" - розділ вхідних документів, що були запущені на погодження (на рівні Вашої організації).
...
**Погодження** - це процес, що дозволяє 

В сервісі **"EDI+ЮЗД"** можливо налаштувати ланцюжок послідовного погодження вхідних документів перед підписанням. На даний момент доступні до погодження типи документів (список буде розширюватись):
...
.. note::
   Налаштування сценаріїв погодження наразі здійснюються через звернення до служби технічної підтримки: `support@edin.ua <mailto:support@edin.ua>`__.

Ви можете побудувати послідовний ланцюжок погодження між будь-якими користувачами компанії, в яких є доступ до документа на рівні GLN. Процес погодження запускає **Ініціатор погодження** (перший користувач в налаштованій послідовності). Тобто схематично послідовність виглядає так: ``"Ініціатор погодження"->"Користувач 1"->"Користувач 2->"Користувач N""``.

Для запуску погодження **Ініціатору** потрібно перейти у вхідний документ, натиснути **"Направити на погодження"** (кнопка доступна лише Ініціаторам) в модальному вікні обрати сценарій та **"Запустити погодження"**:

.. image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_041.png
   :align: center

Після чого документ відображається :underline:`в журналі всіх учасників погодження (лише в учасників)` в розділі **"Погодження"**, даний сценарій погодження отримує статус :orange:`На погодженні`:  

.. image:: pics_rabota_s_platformoj_EDIN_2.0/rabota_s_platformoj_042.png
   :align: center

.. important::
   :underline:`Статуси сценаріїв погодження` (відображаються в журналі документів):

   * :orange:`На погодженні` - документ відправлений на погодження;
   * :green:`Погодження завершено` - погодження за документом завершено;
   * :red:`Очікує мого погодження` - учаснику, якому відображається даний статус потрібно погодити/відхилити документ.

В документі при цьому відображається блок **Протокол погодження**, в якому відображаються всі кроки та поточний етап погодження:
...
5. У журналі документів є можливість відзначити документи, як **"Важливі"** (відмічені заповненою зірочкою |star|), подивитися коментарі в документі (|comment|), а також поставити мітки:
