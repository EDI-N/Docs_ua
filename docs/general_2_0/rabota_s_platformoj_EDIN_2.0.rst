...
.. note::
   Редагування налаштувань сценаріїв погодження наразі можливо здійснити через звернення до служби технічної підтримки: `support@edin.ua <mailto:support@edin.ua>`__.
