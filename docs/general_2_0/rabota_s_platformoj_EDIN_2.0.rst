...
.. note::
   Після запуску нового сценарію він автоматично зберігається до сценаріїв GLN з вхідним документом (**Особистий кабінет->Налаштування->GLN->Форма редагування GLN->** `Сценарії погодження <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#doc-approval>`__), де сценарії погодження можливо переглядати, редагути, видаляти.
