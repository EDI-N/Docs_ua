...
+--------------------------+-------------------------------------+-----------------------------------------+---------------------+-------------------------------+
|Контроль відповідності    |Реалізувати контроль відповідності   |Метою є забезпечення узгодженості        |Для всіх користувачів|Ні                             |
...
|**Доопрацювання**         |**Що зробили?**                 | **Навіщо зробили?**                           |**Для кого зробили?**|**Вплив на роботу по API/FTP?**|
+--------------------------+--------------------------------+-----------------------------------------------+---------------------+-------------------------------+
|Реалізували нагадування   |У розділі керування сповіщеннями|Щоб продавці могли легко керувати оновленням   |Для всіх користувачів|Ні                             |
|про завершення терміну дії|додано новий тип — «Нагадування |прайс-листів, забезпечували безперебійну роботу|сервісу Маркет       |                               |
| прайс-листа.             |про завершення терміну дії прайс|з покупцями та уникали помилок із              |                     |                               |
|                          |-листа».                        |протермінованими товарами.                     |                     |                               |
|                          |Якщо сповіщення ввімкнене,      |                                               |                     |                               |
|                          |продавець отримає листа на пошту|                                               |                     |                               |
|                          |за 3 дні та за 1 день до        |                                               |                     |                               |
|                          |завершення терміну дії прайс-   |                                               |                     |                               |
|                          |листів у деяких покупців. В     |                                               |                     |                               |
|                          |листі буде вказано перелік      |                                               |                     |                               |
|                          |покупців, для яких прайс-лист   |                                               |                     |                               |
|                          |стане недоступним. Також у прайс|                                               |                     |                               |
|                          |-листі на стороні продавця      |                                               |                     |                               |
|                          |додано віртуальну категорію     |                                               |                     |                               |
|                          |«Протерміновані позиції», яка   |                                               |                     |                               |
|                          |знаходиться внизу списку та     |                                               |                     |                               |
|                          |містить товари, термін дії яких |                                               |                     |                               |
|                          |завершився (вони не             |                                               |                     |                               |
|                          |відображаються покупцям).       |                                               |                     |                               |
+--------------------------+--------------------------------+-----------------------------------------------+---------------------+-------------------------------+
|Реалізували завантаження  |Ми реалізували підтримку        |Для зручної роботи з новими покупцями —        |Для всіх користувачів|Ні                             |
|групових прайс-листів та  |групових прайс-листів. Тепер Ви |достатньо додати їх до групи, і вони           |сервісу Маркет       |                               |
|роботу з ними             |можете завантажувати прайс-лист |автоматично отримають груповий прайс-лист.     |                     |                               |
|                          |не лише для окремих покупців, а |А також, для спрощення керування — усі зміни у |                     |                               |
|                          |й на всю групу покупців. Всі    |груповому прайсі одразу застосовуються до всіх |                     |                               |
|                          |учасники групи автоматично      |покупців у групі.                              |                     |                               |
|                          |отримають актуальний прайс. Якщо|                                               |                     |                               |
|                          |ви редагуєте позицію у груповому|                                               |                     |                               |
|                          |прайсі — зміни застосовуються до|                                               |                     |                               |
|                          |всіх покупців у групі. Додали   |                                               |                     |                               |
|                          |нового покупця до групи? — він  |                                               |                     |                               |
|                          |одразу отримає прайс без        |                                               |                     |                               |
|                          |додаткових дій з Вашого боку.   |                                               |                     |                               |
+--------------------------+--------------------------------+-----------------------------------------------+---------------------+-------------------------------+
