...
.. dropdown:: 30. Якщо при підписанні через "Дія.Підпис" у Вас виникає проблема "На жаль, сталася помилка"
   ...
   * деактивувати "Дія.Підпис" та увійти повторно;
   * переавторизуватись у застосунку "Дія" (кнопка Вийти в Меню);
   * змінити інтернет мережу (перейти на мобільні дані, VPN, інший Wi-fi).
