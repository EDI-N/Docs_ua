...
.. Після ініціалізації бібліотеки підписання, система надасть можливість додати або вибрати збережений ключ ЕЦП для підписання. При першому підписанні необхідно додати файловий ключ. Для цього у модальному вікні потрібно обрати файл чи токен (1) і ввести пароль (2), "Считати" активний ключ і "Підписати":
