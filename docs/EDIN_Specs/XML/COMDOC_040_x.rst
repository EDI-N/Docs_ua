...
.. code:: xml
    ...
    <Заголовок>
        ...
        <ТипДокументу>Рахунок (логістика)</ТипДокументу>
        <КодТипуДокументу>040</КодТипуДокументу>
        <ДатаДокументу>2023-12-07</ДатаДокументу>
        <МісцеСкладання>тутачки</МісцеСкладання>
        <НомерКонтракту>Дого</НомерКонтракту>
        <ДатаКонтракту>2023-12-07</ДатаКонтракту>
        <НомерДодаткуДоДоговору>Додаточок</НомерДодаткуДоДоговору>
        <ДатаДодаткуДоДоговору>2023-12-07</ДатаДодаткуДоДоговору>
    </Заголовок>
    <Сторони>
        <Контрагент>
...
.. data from table (remember to renew time to time)
    ...
    1.2	ТипДокументу	M	Рядок (50)	Тип документу: Рахунок (логістика)
    1.3	КодТипуДокументу	M	«040»	Допустиме значення: 040 => Рахунок (логістика) (всі підтипи COMDOC)
