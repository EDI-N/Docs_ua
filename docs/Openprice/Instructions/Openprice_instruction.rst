...
* **Мій прайс-лист** - розділ, в якому відображається Ваш `"Прайс-лист" (PRICAT) <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/XML/XML_structure.html#pricat>`__;
...
Обрані позиції можливо **"Опублікувати"** - товари автоматично додаються до Вашого прайс-листа (розділ **"Мій прайс-лист"**).
...
Ваш `"Прайс-лист" (PRICAT) <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/XML/XML_structure.html#pricat>`__ з усіма діючими позиціями знаходиться в розділі **"Мій прайс-лист"**. При переході в розділ відкривається нове вікно прайс-листа з усіма доданими позиціями, згрупованими за наступною ієрархією: ``Лінійка -> Категорія -> Підкатегорія`` продукції:

.. image:: pics_Openprice_instruction/Openprice_instruction_036.gif
   :align: center

Кожен зцих трьох рівнів натиснувши на назву можливо приховувати/відкривати для більш зручного **перегляду / редагування / видалення**. Для колонки "Назва" передбачене сортування значень за зростанням згідно правила:
...
Можливо видалити конкретні позиції (кнопка |смітник|) чи повністю **"Видалити"** прайс-лист:
...
Кожен зцих трьох рівнів натиснувши на назву можливо приховувати/відкривати для більш зручного перегляду і подальшого формування `"Замовлення" (ORDERS) <https://wiki.edin.ua/uk/latest/Distribution/EDIN_2_0/XML/XML_structure.html#order>`__. Для колонки "Назва" передбачене сортування значень за зростанням згідно правила:
