...
При складному пошуку з багатьма ключами усі параметри повині бути розділені комами, наприклад, ``Категорія: Продукти харчування та напої, Група: Молочні продукти і яйця,``:
