####################################################
Підписання документів ЕЦП на web-платформі (додати картинки)
####################################################
...
Після вибору секретних ключів, введіть паролі під кожним з них, а потім натисніть кнопку **"Вважати ключі"**.
