...
Завершує список, папка **«Документи АТС»**. Яка містить в собі первинну документацію та податкові накладні від ТОВ «АТС». Документ **«Акт наданих послуг»**, вимагає підписання КЕП з вашого боку. Процедура підписання вказана у відповідній інструкції.
