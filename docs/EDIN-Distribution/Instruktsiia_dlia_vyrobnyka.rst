...
Для встановлення квот обов'язковими для заповнення є **GLN** контрагента, для якого встановлюється квота, **Штрихкод** позиції та безпосередню сама **Квота**, тобто кількість товару до замовлення. Зазначений GLN повинен бути серед списку Ваших дистриб'юторів!
