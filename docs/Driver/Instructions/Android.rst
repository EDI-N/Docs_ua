...
.. caution::
   Ми дбаємо про конфіденційність Ваших облікових даних і Ви можете **"Видалити акаунт"**, вказавши причину та повторно підтвердивши дію кнпкою:

   .. image:: /Driver/Instructions/pics_Android/Android_047.png
      :height: 500px
      :align: center

   Однак Ви маєте знати, що будете позбавлені можливості користуватися EDIN Driver, і інші учасники електронного документообігу будуть позбавлені можливості обмінюватися з Вами електронними документами з використанням EDIN Driver!
