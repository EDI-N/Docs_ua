...
Процеси `Підписання <sign-driver>`_ `Підписання<sign-driver>`_ та :ref:`Відхилення<reject-driver>` Актів ідентичні до дій, що виконуються до е-ТТН та описані у відповідних розділах вище (за посиланням). Після Підписання чи Відхилення Акт змінює свій статус з :orange:`"Очікується підписання водієм"` на :green:`"Підписано всіма сторонами"` чи :red:`"Відхилено перевізником/водієм"` відповідно.
