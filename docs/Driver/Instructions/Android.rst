...
Процеси `Підписання <sign>`_ та `Відхилення <reject>`_ Актів ідентичні до дій, що виконуються до е-ТТН та описані у відповідних розділах вище (за посиланням). 
...
.. hint::
   Пошук можливий по 5 значенням (дата документа, статус документа, замовник, вантажоодержувач, перевізник)
