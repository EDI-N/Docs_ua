...
Після завершення процесу заватаження обраний Сертифікат можна знайти в папці із завантаженнями на Вашому комп'ютері. Якщо Сертифікат має кілька вкладень, по натисканню кнопки "Завантажити файл" |завантаж| доступна опція "Завантажити всі файли".
