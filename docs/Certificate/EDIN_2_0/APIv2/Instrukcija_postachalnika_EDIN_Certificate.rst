...
Для додавання товару натисніть кнопку «**Додати**».  У вікні, що з'явилося, заповніть необхідні параметри товару, виділені **червоною зірочкою** (*) та натисніть кнопку «**Зберегти**». 
