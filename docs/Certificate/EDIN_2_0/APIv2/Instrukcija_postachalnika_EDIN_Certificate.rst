...
Далі, в залежності від обраного виду сертифіката, заповнюється поле **Дата закінчення** або **Номер партії**, на який виписаний документ. При виборі типу сертифікату "Об'єднані партії" поля **Дата закінчення** та **Номер партії** необов'язкові для заповнення.
