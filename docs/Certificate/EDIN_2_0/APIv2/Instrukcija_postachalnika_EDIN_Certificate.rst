...
- **Вид сертифіката** - оберіть потрібний вид (по періоду дії документа, за номером партії або об'єднані партії)
- **Дата початку** - дата початку дії сертифікату

Далі, в залежності від обраного виду сертифіката, заповнюється поле **Дата закінчення** або **Номер партії**, на який виписаний документ. При виборі виду сертифікату "Об'єднані партії" поля **Дата закінчення** та **Номер партії** необов'язкові для заповнення.
...
#.	Санітарна обробка автомобіля
#.	Медична Книжка
#.	Документ про повноваження представника постачальника
#.	Акт фумігації вантажу
#.	Ліцензія на провадження господарської діяльності
#.	Реєстрація виробничої потужності
#.	Сертифікат виробничої потужності
...
Після ввода причини відхилення і натискання кнопки «**Відхилити**» праворуч відхиленої скарги замість іконки |крапки| з'явиться іконка |комент|. При натисненні іконки |комент| можна подивитись причину відхилення:
