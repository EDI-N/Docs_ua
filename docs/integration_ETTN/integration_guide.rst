...
Розроблений компанією EDIN інтеграційний модуль сервісу EDIN "ETTN" (в подальшому просто модуль) дозволяє працювати з обліковими системами 1С: Підприємство 8.Х :underline:`на звичайних формах` (надалі 1С) на базі операційної системи Windows.
...
.. image:: pics_integration_guide/integration_guide_02.jpg
   :align: center
...
.. image:: pics_integration_guide/integration_guide_03.jpg
   :align: center 
...
.. image:: pics_integration_guide/integration_guide_05.jpg
   :align: center
...
.. image:: pics_integration_guide/integration_guide_21.jpg
   :align: center
...
`Опис конфігураційного файлу Config.txt модуля для інтеграції з сервісом EDIN "ETTN" <https://wiki.edi-n.com/uk/latest/поки_відсутній.html>`__ .
