...
З 1С | BAS-Підприємства запускаємо файл зовнішньої обробки **Integration_ (версія_модуля).epf** (Файл-> Відкрити)

.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_025.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_026.png
   :align: center

1.3. В викликаному меню «**Інтеграція: Налаштування**» перейти в **Майстер налаштувань**:

.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_027.png
   :align: center

1.4. У вікні Майстра налаштувань послідовно виконати налаштуваня у вкладках розташованих зліва:

.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_028.png
   :align: center

1.5. У вкладці «**Загальні настройки інтеграції**» в випадаючому списку вибрати Вид конфігурації (1) в якій працює Ваша 1С | BAS.

.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_029.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_030.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_031.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_032.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_033.png
   :align: center

.. note :: Якщо планується працювати з великою кількістю документів, то при синхронізації на закачування нових документів може знадобитися більше часу (1С | BAS спочатку закачує, а потім обробляє Додані файли). Для прискорення процесу синхронізації можливо використовувати **FTP-клієнт**, який у фоновому режимі закачує файли і також автоматично відсилає файли, підготовлені до відправки. В цьому випадку FTP клієнт завантажує файли з сервера в локальний каталог, а 1С | BAS працює вже з локальними каталогами. Для активації цієї функції встановіть галочку навпроти «**Завантажувати файли з використанням локального каталогу**».

1.10. Налаштування на вкладці «**Налаштування ЕЦП**» необхідно виконати в разі роботи з юридично значущими документами.
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_034.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_035.png
   :align: center
...
.. image:: pics_prog_1C_FTP_integration/prog_1C_FTP_integration_036.png
   :align: center
