...
3. Після того, як документи 1С сформовані можливо подвійним кліком миші по значенню рядка **"Заказ"** (1С) чи **"Реализация"** (1С) відкрити документ, внести в ньому за потреби зміни та зберегти.
