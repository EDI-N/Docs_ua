...
Доповнення виконується для основних блоків документа: Вантажовідправник, Вантажоодержувач, Замовник, Водій, Автомобіль, Причіп/напівпричіп, Пункти навантаження та розвантаження. Для кожного з них достатньо вказати ідентифікатор (GLN, ІПН або реєстраційний номер). Решта реквізитів — назва, адреса, контакти, технічні характеристики, дані водія чи транспортного засобу — автоматично доповнюються із системи EDIN.
