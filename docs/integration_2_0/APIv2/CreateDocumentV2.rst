...
.. hint:: Також можливо виконати запит у вигляді curl-рядка:
          ...
          curl -X POST 'https://edo-v2.edi-n.com/api/eds/doc?gln=9864065702429&doc_type=orders' -d {json - тело документа} -b 'SID=458a0d38-5b56-4b8e-8998-009a1edd31eb'
...
Таблиця 4 - Опис json-параметрів, що можуть передаватися у **відповідь** (об'єкт створеного документа-чернетки) на метод API.
