...
|                                                              |                                                                                                                                                                       |
|                                                              | **partner_id** - число; id торгової мережі (можливо отримати з `довідника торгових мереж <https://wiki.edi-n.com/uk/latest/integration_2_0/API/Allretailers.html>`__) |
|                                                              |                                                                                                                                                                       |
