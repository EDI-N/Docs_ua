...
.. attention::
 ...
 відповідного провайдера підписання або, як у випадку з "DepositSign"

.. tabs::

   .. tab:: Підписання від "ПриватБанку"

      Після того, як Ви обрали провайдера хмарного підписання, генерується qr-код для переходу в мобільний додаток:
      ...
      Далі потрібно ще раз відсканувати qr-код в мобільному додатку **"Privat24"** (потрібно повторно виконати дії в додатку описані вище).
   ...
   .. tab:: Підписання від "CloudKey"
      ...
      Далі потрібно ще раз відсканувати qr-код в мобільному додатку **"CloudKey"** (потрібно повторно виконати дії в додатку описані вище).
   ...
   .. tab:: Підписання від "ПУМБ"
      ...
      Далі потрібно ще раз відсканувати qr-код в мобільному додатку **"ПУМБ Digital Business"** (потрібно повторно виконати дії в додатку описані вище).
   ...
   .. tab:: Підписання від "DepositSign"
