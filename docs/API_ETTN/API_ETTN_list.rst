...
.. hint::
    Всі запити нижче перерахованих API методів сервісу "ЕТТН" направляються на адресу: https://edo-v2.edi-n.com 
...
+-----------+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| POST      | ``/api/ettn/eds/act/xml``    | `Створення XML "Акта перевантаження" для подальшого підписання <https://wiki.edin.ua/uk/latest/API_ETTN/Methods/CreateActXml.html>`__       |
+-----------+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| POST      | ``/api/ettn/eds/act/sign``   | `Підписання "Акта перевантаження" <https://wiki.edin.ua/uk/latest/API_ETTN/Methods/SaveActSign.html>`__                                     |
+-----------+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| PATCH     | ``/api/ettn/eds/act/send``   | `Відправка "Акта перевантаження" Перевізником, що здає вантаж (ініціатор) <https://wiki.edin.ua/uk/latest/API_ETTN/Methods/SendAct.html>`__ |
+-----------+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
| PUT       | ``/api/ettn/eds/act/reject`` | `Відхилити "Акт перевантаження" <https://wiki.edin.ua/uk/latest/API_ETTN/Methods/RejectAct.html>`__                                         |
+-----------+------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------+
