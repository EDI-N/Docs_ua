##########################################################################################################################
Формування документа «Додаток до повідомлення про відвантаження» (QUOTES) на платформі (додати картинки)
##########################################################################################################################
---------
...
Для завантаження серійних номерів через шаблон, натисніть на кнопку «**Завантажити шаблон Excel**». Після чого почнеться скачування файлу.
...
Для збереження документа натискаємо на кнопку «**Зберегти**», а потім - «**Надіслати**».
