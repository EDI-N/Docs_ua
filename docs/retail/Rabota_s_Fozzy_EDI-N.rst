...
Дана інструкція описує порядок формування документів від постачальника «Підтвердження замовлення» (ORDRSP) і «Повідомлення про відвантаження» (DESADV) у відповідь на **Замовлення**, та підписання або відмову від підписання Комерційного документа «Прибуткова Накладна» по мережі Фоззі. 
...
.. admonition:: Важливо!
   ...
   Різниця між вказаною кількістю товару в повідомленні про відвантаження та фактично прийнятою кількістю, зазначається в паперовому Акті невідповідності.
...
:red:`Перед підписання потрібно звірити вірність вказаних позицій: кількість та номенклатуру прийнятих позицій, ціну з ПДВ та без ПДВ, одиниці виміру;`
...
У випадку розходження – прийняти Акт про виявлені недоліки, де по кожному товару причина невідповідності.
