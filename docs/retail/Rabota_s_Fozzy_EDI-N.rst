...
У випадку розходження – Акт про виявлені недоліки, де по кожному товару причина невідповідності.

У журналі червоним буде видклено попередження **Постака потребує закриття!**
