...
.. important:: **Увага!**  Для коректного формування документів, необхідно заповнити Товарний довідник. Ви можете подивитися `Інструкцію щодо заповнення довідника <https://wiki.edin.ua/uk/latest/general/Zapolnenie_Tovarnogo_spravochnika.html>`_.
...
У разі отримання статусу «**Помилка при реєстрації в ЄРПН**» прохання звертатися за адресою ел. пошти support@edin.ua.
