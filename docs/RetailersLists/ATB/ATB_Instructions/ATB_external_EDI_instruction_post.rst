...
.. uml::
   ...
   Постачальник <- АТБ: Замовлення (ORDER)
   Постачальник -> АТБ: Повідомлення про відвантаження (DESADV)
   Постачальник -> АТБ: Видаткова накладна (COMDOC_006)1 підпис
   ...
   Постачальник <- АТБ: Акт про виявлені недоліки (COMDOC_005)1 підпис
   Постачальник -> АТБ: Акт про виявлені недоліки (COMDOC_005) 2 підписи
   Постачальник <- АТБ: Видаткова накладна (COMDOC_006) 2 підписи
...
.. uml::
   ...
   Постачальник <- ТОВ АТБ Маркет: Замовлення (ORDER)
   Постачальник -> ТОВ АТБ Маркет: Повідомлення про відвантаження (DESADV)
   Постачальник -> ТОВ АТБ Маркет: Видаткова накладна (COMDOC_006)1 підпис
   Постачальник -> ТОВ Логістик Юніон: Акт приймання товару (складська логістика) (COMDOC_032)1 підпис
   Постачальник <- ТОВ Логістик Юніон: Акт розбіжностей до АПП (COMDOC_034)1 підпис
   Постачальник <- ТОВ Логістик Юніон: Акт приймання товару (COMDOC_033)1 підпис
   Постачальник -> ТОВ Логістик Юніон: Акт розбіжностей до АПП (COMDOC_034) 2 підписи
   Постачальник -> ТОВ Логістик Юніон: Акт приймання товару (COMDOC_033) 2 підписи
   Постачальник <- ТОВ Логістик Юніон: Акт приймання товару (складська логістика) (COMDOC_032) 2 підписи
   Постачальник <- ТОВ АТБ Маркет: Акт про виявлені недоліки (COMDOC_005)1 підпис
   Постачальник -> ТОВ АТБ Маркет: Акт про виявлені недоліки (COMDOC_005) 2 підписи
   Постачальник <- ТОВ АТБ Маркет: Видаткова накладна (COMDOC_006) 2 підписи
