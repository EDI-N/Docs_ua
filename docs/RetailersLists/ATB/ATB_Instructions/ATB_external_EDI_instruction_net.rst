...
1.2 Формування у відповідь "Акта про виявлені недоліки" (COMDOC_005). Сторона мережі "АТБ"
----------------------------------------------------------------------------------------------------------------------------

Для формування "Акта про виявлені недоліки" (COMDOC_005) виберіть відповідний документ на формі-підказці - документ створиться автоматично.

.. image:: pics_ATB_external_EDI_instruction/ATB_external_EDI_instruction_100.png
   :align: center

У відкритій формі "Акта про виявлені недоліки" (COMDOC_005) всі поля заповнюються автоматично з пов'язаного документа-підстави. Блок табличної частини з переліком позицій також заповнюються автоматично з документа-основи. Документ засвідчує невідповідність кількості товарних позицій:
...
2.1 Підписання та формування "Акта приймання товару" (COMDOC_033) у відповідь. Сторона "Логістик Юніон"
----------------------------------------------------------------------------------------------------------------------------
...
2.1.1 Формування "Акта приймання товару" (COMDOC_033). Сторона "Логістик Юніон"
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
