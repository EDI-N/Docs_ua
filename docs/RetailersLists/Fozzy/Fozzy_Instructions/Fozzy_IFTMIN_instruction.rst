...
.. image:: pics_Fozzy_IFTMIN_instruction/Fozzy_IFTMIN_instruction_001.png
   :align: center

У відкритому документі на формі-підказці виберіть зі списку **"Інструкція з транспортування"**:

.. image:: pics_Fozzy_IFTMIN_instruction/Fozzy_IFTMIN_instruction_002.png
   :align: center
...
.. attention::
   ...
   .. image:: pics_Fozzy_IFTMIN_instruction/Fozzy_IFTMIN_instruction_003.gif
      :align: center
...
.. image:: pics_Fozzy_IFTMIN_instruction/Fozzy_IFTMIN_instruction_004.png
   :align: center
