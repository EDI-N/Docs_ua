...
Документи завантажуються у вигляді zip-архівів (наіменування архіву = перші_10_символів теми_документа+Дата+Час_створення). Кожен з архівів містить каталоги (найменування=назві файлу з роширенням) для кожного вкладення. Кожен каталог містить:
