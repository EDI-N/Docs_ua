Вільний у Вашому кабінеті
#############################################################

.. role:: green

Сервіс "Вільний" можливо вбудувати в особистий кабінет сайту за допомогою кількох простих кроків і отримати організувати електронний документообіг прямо у Вас на сайті під	власним	брендом:
...
.. important::
    Ініціалізація сесії повинна виконуватись на Вашій стороні (на стороні клієнтського сервера) в цілях безпеки.  
...
+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **REQUEST**       | **JSON Body:** в тілі запиту передається об'єкт з даними користувача:                                                                                                                               |
|                   |                                                                                                                                                                                                     |
...
+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **RESPONSE**      | в тілі відповіді (json) передається об'єкт з ``session_id`` - ідентифікатором сесії                                                                                                                 |
+-------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
**2. Ініціалізувати iFrame бібліотеку на своїй сторінці (в своєму особистому кабінеті):**
...
.. note::
    Після того, як iFrame бібліотека пройде ініціалізацію, в цілях безпеки ключ ``session_id`` видаляється і створити таку ж сесію буде неможливо. 
