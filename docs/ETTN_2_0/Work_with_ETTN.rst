...
**3 Сценарії взаємодії з контрагентами**
================================================
...
ЕТТН також можливо створити на підставі підписаного з обох сторін "Акта приймання-передавання" ( `детальніше про Акт <https://wiki.edi-n.com/uk/latest/ETTN_2_0/Work_with_acceptance_certificate.html>`__ )
...
* Тарифи (4) - налаштування автоматичного підрахування цін за послугу «Перевізника» (`детальніше <https://wiki.edi-n.com/uk/latest/ETTN_2_0/Create_act_at_accepted_work.html#additional-functionality>`__ )
