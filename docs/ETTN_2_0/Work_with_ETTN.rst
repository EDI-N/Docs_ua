...
.. note::
    Для каталогу "Вхідні" для **"Перевізника"** доступна кнопка |фільтр| - фільтр, що дозволяє відсортувати ЕТТН документи, що потребують підтвердження по яким можливо створити "Акт перевантаження" / "Акт виконаних робіт" ( `детальніше <https://wiki.edi-n.com/uk/latest/ETTN_2_0/Work_with_ETTN.html#act_creation>`__ ) 
