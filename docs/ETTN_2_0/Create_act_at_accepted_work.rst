...
.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_29.png
   :align: center

Далі серед своїх компаній (якщо їх кілька) обрати компанію, для якої будуть виконані наступні налаштування:

.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_30.png
   :align: center

Обрати вкладку **"Тарифи"** та натиснути кнопку **"+Додати"**:

.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_31.png
   :align: center
...
.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_32.png
   :align: center

Налаштування можливо видалити в будь-який момент:

.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_33.png
   :align: center
