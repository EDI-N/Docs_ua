...
.. important::
   Функціонал створення актів доступний для компанії з роллю **"Перевізника"** на підставі підписаного з трьох сторін ЕТТН (в статусі "Підписано перевізником" чи повторно "Очікує підписання водієм / перевізником"):
...
Після того, як обов'язкові поля документа (позначені червоною зірочкою :red:`*`) будуть заповнені його можливо буде **"Зберегти"** (1) - створюється документ-чернетка та **"Підписати"** (2):

.. image:: pics_Create_act_at_accepted_work/Create_act_at_accepted_work_40.png
   :align: center
