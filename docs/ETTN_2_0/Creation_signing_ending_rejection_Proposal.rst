...
Якщо **"Вантажовідправник"** вже вказав дані водія при формуванні документа, то блок **"Дані по авто і водієві"** вже буде в документі:
...
.. hint::
   Процес підписання документа **"Перевізником"** не відрізняється від підписання **"Вантажовідправником"** та описаний в `розділі вище <https://wiki.edin.ua/uk/latest/ETTN_2_0/Creation_signing_ending_rejection_Proposal.html#sign>`__ .

.. important::
   Якщо **"Вантажовідправник"** вірно вказав дані водія, то "Заявки на транспортування" не потребує створення "Підтвердження транспортування". Документообіг завершено.
