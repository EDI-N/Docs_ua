...
* **Адреса** – необхідно обрати з випадаючого списку (для навантаження значення підтягуються з довідника **"Вантажовідправника"**, а для розвантаження - **"Вантажоодержувача"**) або можливо ввести **"Нові адреси"**. При введенні нової адреси потрібно ввести адресу, населений пункт (достатньо почати вводити назву населеного пункту та обрати його зі списку) - при цьому код КАТОТТГ вказується автоматично;
