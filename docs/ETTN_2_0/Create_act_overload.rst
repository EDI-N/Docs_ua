...
Для того аби створити "Акт перевантаження" потрібно перейти до каталогу **"Вхідні"** та скористатись кнопкою |фільтр| фільтром, що дозволяє відсортувати ЕТТН документи, на підставі яких може бути створений відповідний акт.
...
Відправлений "Акт про перевантаження" має наступний вигляд:
