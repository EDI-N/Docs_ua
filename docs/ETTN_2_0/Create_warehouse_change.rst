...
2) "Вантажоодержувач" **=>** :green:`"Вантажоодержувач" -> "Перевізник" -> "Замовник"` (3 підписанта)
2.1) "Вантажоодержувач"="Замовник" **=>** :green:`"Вантажоодержувач" -> "Перевізник"` (2 підписанта)
...
Розглянемо, для прикладу, формування "Акта про заміну пункту призначення вантажу" зі сторони **"Вантажовідправника"** (з трьома підписантами).
...
Для того аби створити "Акт про заміну пункту призначення вантажу" потрібно перейти до каталогу **"Вхідні"** (**"Надіслані"** в випадку Ініціатора-Вантажовідправника) та перейти в "Товарно-транспортну накладну"до якої може бути створений коригуючий акт ("е-ТТН" в статусі "Очікує підписання вантажоодержувачем"):
