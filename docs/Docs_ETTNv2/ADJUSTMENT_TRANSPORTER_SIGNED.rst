...
1) "Вантажовідправник" **=>** "Вантажовідправник" -> "Перевізник" -> :green:`"Вантажоотримувач"` (3 підписанта)

2) "Перевізник" **=>** "Перевізник" -> "Вантажовідправник" -> :green:`"Вантажоотримувач"` (3 підписанта)

3) "Вантажоотримувач" **=>** "Вантажоотримувач" -> "Вантажовідправник" -> :green:`"Перевізник"` (3 підписанта)

4) "Замовник" **=>** "Замовник" -> "Вантажовідправник" -> :green:`"Перевізник"` -> "Вантажоотримувач" (4 підписанта)
