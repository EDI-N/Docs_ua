XML Специфікації для роботи з мережею "Файно Маркет"
#######################################################

У специфікації представлено опис полів XML-документів, які застосовуються в електронному обміні даними при роботі з мережею "Файно Маркет" на платформі EDIN.

В електронному обміні даними з мережею "Файно Маркет" використовуються стандартні XML-документи. Опис полів стандартних XML-документів можна знайти за наступними посиланнями:
