...
.. image:: pics_Novus/Novus_EDI_001.png
   :height: 700px
   :align: center
...
Інструкція по формуванню "Податкової накладної" на підставі "Прибуткової накладної" зараз на стадії оновлення. Стару інструкцію можна знайти за `посиланням <https://wiki.edin.ua/uk/latest/retail_2.0/Formuvannya_Podatkovoyi_Nakladnyy_na_pidstavi_Prybutkovoyi_nakladnoyi.html>`__
