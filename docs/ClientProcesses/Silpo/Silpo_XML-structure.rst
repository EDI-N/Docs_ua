...
Для детальної інформації ознайомтесь з `Інструкцією по роботі з мережею Сільпо <https://wiki.edin.ua/uk/latest/ClientProcesses/Silpo/Silpo_Instructions/Robota_s_Fozzy_EDI-N_2.0.html>`__.
