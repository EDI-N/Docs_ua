...
.. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_021.png
   :height: 500px
   :align: center
...
.. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_022.png
   :height: 500px
   :align: center
...
.. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_015.png
   :height: 500px
   :align: center
...
.. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_016.png
   :height: 500px
   :align: center
...
.. hint::
   ...
   .. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_017.png
      :height: 500px
      :align: center

Для **зміни чи додавання ключа підпису** потрібно у вкладці **"Користувач"** обрати **"Ключ підпису"**. Після `Додавання ключа <https://wiki.edin.ua/uk/latest/ClientProcesses/Silpo/Silpo_Instructions/Silpo_EDIN_Driver.html#key-add>`__ (опис за посиланням) Вам відкриються детальні дані доданого ключа, що автоматично підтягується для `Підписання <https://wiki.edin.ua/uk/latest/ClientProcesses/Silpo/Silpo_Instructions/Silpo_EDIN_Driver.html#sign>`__:

.. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_018.png
   :height: 500px
   :align: center
...
.. hint::
   ...
   .. image:: pics_Silpo_EDIN_Driver/Silpo_EDIN_Driver_019.png
      :height: 500px
      :align: center
