...
У на підставі свого **«Повідомлення про відвантаження»(DESADV)** Постачальник може сформувати **«Накладну за кількістю»(DOCUMENTINVOICE)** (детальніше в `інструкції <https://wiki.edin.ua/uk/latest/retail_2.0/Fozzy_DOCUMENTINVOICE_instruction.html>`_).
