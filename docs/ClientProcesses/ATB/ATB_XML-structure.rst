...
XML специфікація документа **Повідомлення про прийом** (RECADV) є стандартною, її можна знайти за `посиланням. <https://wiki-v2.edin.ua/books/xml-specifikaciyi-dokumentiv/page/povidomlennia-pro-priiom-recadv>`__
