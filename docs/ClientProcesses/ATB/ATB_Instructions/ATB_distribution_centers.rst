########################################################################################################################
Документообіг з мережею "АТБ" на платформі EDI Network 2.0: "Розподільчі центри"
########################################################################################################################
...
#. **За накладною №** / **від** - номер та дата накладної.
...
3 Формування "Інструкції про повернення" (RETINS). Сторона Постачальника
=========================================================================================================================
...
.. image:: pics_ATB_distribution_centers/ATB_distribution_centers_006.png
   :align: center
