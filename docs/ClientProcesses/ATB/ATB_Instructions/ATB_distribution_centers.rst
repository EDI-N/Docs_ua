...
.. include:: /ClientProcesses/ATB/ATB_Instructions/ATB_International_transportation_instruction.rst
   :start-after: .. початок блоку для ATB_distribution_centers_ORDRSP
   :end-before: .. кінець блоку для ATB_distribution_centers_ORDRSP

.. Якщо зростеться, то це все буде сміттям   Мережа "АТБ" формує і відправляє "Замовлення" (ORDER). Для формування "Підтвердження замовлення" (ORDRSP) потрібно у папці **"Вхідні"** обрати "Замовлення" (ORDER), за яким потрібно зробити підтвердження (для зручності можливо скористатись `пошуком <https://wiki.edin.ua/uk/latest/general_2_0/rabota_s_platformoj_EDIN_2.0.html#doc-search>`__):

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_008.png
      :align: center

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_009.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_010.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_011.png
      :align: center
   ...
   .. hint::
      ...
      .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_024.png
         :align: center

   8. **Дата доставки** - дата доставки, за замовчуванням вказується дата з "Замовлення" (ORDER);
   9. **Валюта замовлення** - вибір валюти;
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_013.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_012.png
      :align: center
   ...
   .. вирішили прибрати, але для інших інструкцій ок - Можливо також додати іншу позицію з Товарного довідника, заповнивши форму **Додати позицію** через кнопку **"+Додати"** (обов'язкові до заповнення поля позначені червоною зірочкою :red:`*`).
      ...
      .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_020.png
         :align: center

   Після внесення всіх даних в документ, натисніть кнопку **"Зберегти"** (1), потім **"Відправити"** (2).

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_014.png
      :align: center

   Відправлений документ автоматично потрапляє в папку **"Надіслані"** і буде знаходиться в ланцюжку документів разом із "Замовленням" (ORDER).

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_015.png
      :align: center
...
.. include:: /ClientProcesses/ATB/ATB_Instructions/ATB_International_transportation_instruction.rst
   :start-after: .. початок блоку для ATB_distribution_centers_DESADV
   :end-before: .. кінець блоку для ATB_distribution_centers_DESADV

.. Якщо зростеться, то це все буде сміттям   Для формування "Повідомлення про відвантаження" (DESADV) потрібно у папці **"Надіслані"** обрати "Підтвердження замовлення" (ORDRSP), за яким потрібно зробити відвантаження (для зручності можливо скористатись `пошуком <https://wiki.edin.ua/uk/latest/general_2_0/rabota_s_platformoj_EDIN_2.0.html#doc-search>`__):

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_016.png
      :align: center

   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_017.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_018.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_019.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_021.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_022.png
      :align: center
   ...
   .. image:: pics_ATB_distribution_centers/ATB_distribution_centers_023.png
      :align: center
...
.. image:: pics_ATB_distribution_centers/ATB_distribution_centers_002.png
   :align: center
...
.. image:: pics_ATB_distribution_centers/ATB_distribution_centers_005.png
   :align: center
...
Нище блок, де вказана додаткова інформація: версія документа, інформація за позиціями. Щоб переглянути додаткову інформацію, натисніть на **Розгорнути**. 

У табличній частині вказано порядковий № позиції, її Найменування, Штрихкод, Кількість до повернення та Одиниці виміру.

.. image:: pics_ATB_distribution_centers/ATB_distribution_centers_007.png
   :align: center
...
.. image:: pics_ATB_distribution_centers/ATB_distribution_centers_001.png
   :align: center
