...
.. hint::
   Якщо Ви вже раніше відправляли "Акт приймання-передачі (додаток 8)" (COMDOC_032), то в полі "Прізвище" можливо обрати відповідального співробітника (його дані підтягнуться автоматично) або ж **"Додати"** нове прізвище (після відправки документа воно зберігається автоматично):
