...
**Поля, які обов'язкові для заповненя:**
   ...
   4. "Ціна без ПДВ за одиницю, грн";
      ...
      9. "Вид пакування";
      10. "Загальна сума без ПДВ, грн";
      11. "Назва транспортної упаковки".

      ВАНТАЖНО-РОЗВАНТАЖУВАЛЬНІ ОПЕРАЦІЇ
   5. "Дата і час прибуття";
   6. "Дата і час вибуття".
...
Перелік інструкцій із роботи з Актами описано в окремій `інструкції <https://wiki.edin.ua/uk/latest/ETTN_3_0/ETTN_3_0_list.html#disagreement-act>`__.


.. кінець блоку для work_with_acts

.. important::
   У разі, якщо мережа надіслала статус із помилкою опрацювання "е-ТТН", необхідно повторно створити весь ланцюжок документів, починаючи з **«Повідомлення про відвантаження» (DESADV)**.
   Під час заміни документа (при збереженні його номера) слід збільшити значення поля **«Версія»** на одиницю — (n + 1).
