...
2.2 Формування "Видаткової накладної" (COMDOC_006). Сторона Постачальника
-----------------------------------------------------------------------------------------------------------------------------
...
.. hint::
   **На підставі** - поле для вибору типу документа-підстави. Заповнюється автоматично з документа-підстави ("Повідомлення про відвантаження" (DESADV)). Якщо ці дані повністю чи частково відсутні, то при виборі "Договір" можливо обрати зі списку один із :underline:`"Договорів поставки"` з цим контрагентом (**Особистий кабінет->** `Договори <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html#gln-contracts>`__):

   .. image:: pics_ATB_external_EDI_instruction/ATB_external_EDI_instruction_144.png
      :align: center

   або ж **"Додати"** новий договір (після відправки документа дані договору зберігаються автоматично):

   .. image:: pics_ATB_external_EDI_instruction/ATB_external_EDI_instruction_145.png
      :align: center
...
2.3 Отримання "Повідомлення про прийом" (RECADV). Сторона Постачальника
-----------------------------------------------------------------------------------------------------------------------------
...
2.4 Отримання і підписання "Акта приймання товару до ВН" (COMDOC_035). Сторона Постачальника
-----------------------------------------------------------------------------------------------------------------------------
...
.. hint::
   Якщо Ви вже раніше відправляли "Акт приймання-передачі (додаток 8)" (COMDOC_032), то в полі "Прізвище" можливо обрати відповідального співробітника (його дані підтягнуться автоматично) або ж **"Додати"** нове прізвище (після відправки документа дані відповідального співробітника зберігаються автоматично):

   .. image:: pics_ATB_external_EDI_instruction/ATB_external_EDI_instruction_142.gif
      :align: center
