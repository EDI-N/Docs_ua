...
.. important::
   ...
   5. Повна інформація про компанію.
      ...
      *Зайва кома, або інший тип лапок, або інший регістр в електронних документах призводять до помилки документа. Документи з помилками не обробляються, приймання товару блокується.*
