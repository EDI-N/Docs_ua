...
.. uml::
   ...
   Постачальник -> ЛЮ: Акт приймання-передачі (додаток 8) (COMDOC_032) - 1 підпис
   Постачальник <- ЛЮ: Акт приймання товару до АПП (COMDOC_034) - 1 підпис
   Постачальник <- ЛЮ: Акт приймання-передачі (додаток 9) (COMDOC_033) - 1 підпис
   Постачальник -> ЛЮ: Акт приймання товару до АПП (COMDOC_034) - 2 підписи
   Постачальник -> ЛЮ: Акт приймання-передачі (додаток 9) (COMDOC_033) - 2 підписи
   Постачальник <- ЛЮ: Акт приймання-передачі (додаток 8) (COMDOC_032) - 2 підписи

   == Завершення блоку роботи з ТОВ "Логістик Юніон" ==

   АТБ -> Постачальник: Акт приймання товару до ВН (COMDOC_035) - 1 підпис
   АТБ <- Постачальник: Акт приймання товару до ВН (COMDOC_035) - 2 підписи
...
#. **Акт приймання-передачі (додаток 9)(складська логістика) №** - номер "Акта приймання-передачі (додаток 8)";
