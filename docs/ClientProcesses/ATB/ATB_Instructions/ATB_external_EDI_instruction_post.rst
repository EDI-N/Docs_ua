...
**Додаткові поля, які обов'язкові для заповненя при роботі з мережою "АТБ":**
   ...
   ВІДОМОСТІ ПРО ВАНТАЖВ модальному вікні **"Відомості про вантаж"**, що відкривається після натискання на кнопку **"+ Додати"**:
   1. **"Штрихкод"**;
   2. **"Артикул покупця"**;
   3. **"Артикул продавця"**;
   4. **"Код УКТЗЕД"**;
...
.. кінець блоку для work_with_acts
   ...
   .. note::
      У разі, якщо мережа надіслала статус із помилкою опрацювання «е-ТТН», необхідно:
