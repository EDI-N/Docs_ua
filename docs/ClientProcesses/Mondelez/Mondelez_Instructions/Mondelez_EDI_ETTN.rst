...
* для кредиторської заборгованості: назва перевізника з "Акта наданих послуг (Логістика)" (COMDOC_037) + № "Акта наданих послуг (Логістика)" (COMDOC_037);
