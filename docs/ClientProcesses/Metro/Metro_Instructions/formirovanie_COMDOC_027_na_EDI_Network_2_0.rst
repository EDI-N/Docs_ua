...
Дана інструкція описує документообіг `"Товарною накладної" (COMDOC_027) <https://wiki.edin.ua/uk/latest/XML/XML-structure.html#comdoc-027>`__ на платформі EDI Network між Постачальником "FM Logistic" та Мережею "МЕТРО". Ініціатором документообігу виступає Постачальник "FM Logistic".
