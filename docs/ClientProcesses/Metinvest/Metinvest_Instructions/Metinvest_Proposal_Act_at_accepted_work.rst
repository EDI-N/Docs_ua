...
.. tabs::
   ...
   .. tab:: **Створити "Акт виконаних робіт" на підставі однієї "Заявки на транспортування"**
   ...
   .. tab:: **Створити "Акт виконаних робіт" на підставі кількох "Заявок на транспортування"**
