...
Актуальну версію документації ви знайдете за новим `посиланням <https://wiki-v2.edin.ua/books/mereza-fora>`__
...
.. deprecated
   ...
   .. toctree::
      ...
      Fora_Instructions/Fora_Match_Invoice

   .. toctree::
      :caption: Специфікації документів (XML) для роботи з мережею "Фора" [1]
      :maxdepth: 1
