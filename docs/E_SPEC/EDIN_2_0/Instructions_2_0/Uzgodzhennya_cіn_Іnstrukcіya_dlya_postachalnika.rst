...
Створити пропозицію (документ **"Товарне узгодження"** `AGREEM <https://wiki.edi-n.com/uk/latest/general_2_0/massovi_operacii_EDIN_2.0.html#id9>`__) в контракті можливо шляхом вивантаження xls-файлу (згідно шаблону) чи в якості формування "Переузгодження" на всі/окремі товарні позиції в контракті.
...
Для ініціювання процесу переузгодження необхідно створити **"Товарне узгодження"** (документ `AGREEM <https://wiki.edi-n.com/uk/latest/general_2_0/massovi_operacii_EDIN_2.0.html#id9>`__), обравши попередньо бажані товарні позиції з контракту.
...
Відображається лише список мереж, з якими працює Постачальник, а також увімкнені налаштування на платформі (за потреби звертайтесь на support@edi-n.com ). Якщо мережа не завантажила акції, то при натисканні на блок з назвою мережі виводиться повідомлення: 
