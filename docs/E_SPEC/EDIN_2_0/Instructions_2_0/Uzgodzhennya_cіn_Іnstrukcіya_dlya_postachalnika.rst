...
Створити пропозицію в контракті можливо шляхом вивантаження xls-файлу (згідно шаблону) чи в якості формування "Переузгодження" на всі/окремі товарні позиції в контракті.
...
Для ініціювання процесу переузгодження необхідно створити **"Товарне узгодження"**, обравши попередньо бажані товарні позиції з контракту.
...
Обновить вкладку с пропозиціями!!!!
