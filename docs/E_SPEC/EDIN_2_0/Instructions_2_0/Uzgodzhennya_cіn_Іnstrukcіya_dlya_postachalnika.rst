...
Товарні позиції в контракті відображаються в алфавітному порядку. Створити пропозицію (документ **"Товарне узгодження"** `AGREEM <https://wiki.edi-n.com/uk/latest/general_2_0/massovi_operacii_EDIN_2.0.html#id9>`__) в контракті можливо шляхом вивантаження xls-файлу (згідно шаблону) чи в якості формування "Переузгодження" на всі/окремі товарні позиції в контракті.
