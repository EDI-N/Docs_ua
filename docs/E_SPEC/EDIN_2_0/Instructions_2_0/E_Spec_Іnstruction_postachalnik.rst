...
1 Концепція сервісу Е-СПЕЦИФІКАЦІЯ
===============================================================
...
.. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_01.png
   :align: center

Основне вікно сервісу **Е-СПЕЦИФІКАЦІЯ** містить:

.. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_02.png
   :align: center
...
6. Перехід в меню сервісів;
7. Вибір мови інтерфейсу;
8. `Особистий кабінет <https://wiki.edin.ua/uk/latest/Personal_Cabinet/PCInstruction.html>`__, `налаштування користувача <https://wiki.edin.ua/uk/latest/general_2_0/rabota_s_platformoj_EDIN_2.0.html#pers-settings>`__ та вихід з платформи.


.. устарело Сервіс містить чотири основні вкладки: **"Пропозиції"**,**"Контракти"**, **"Акції"** та **"Новинки"**. 

3 Товарне узгодження
===============================================================

Після того як **Покупець** (мережа) вивантажить актуальний товарний довідник (контракт, специфікацію) у **Постачальника** в сервісі **Е-СПЕЦИФІКАЦІЯ** у розділі **ДОВІДНИКИ** у вкладці **Специфікація** відобразиться перелік мереж та діючих специфікацій з мережею. Усі специфікації зручно згруповані по назві мережі. Потрібно обрати мережу та **"Перейти"** в одну з актуальних специфікацій:
...
Для всіх "промо-пропозицій" можливо обрати `Акції`_, якщо вони були додані мережею і їх дати не конфліктують з датами створюваного документа-пропозиції на підставі договору з цією мережею.
...
Функціонал **"Додати/Вилучити позицію"** та встановлені правила заповнення "Дат дії нової ціни" перед "Надсиланням" документа описані в розділі 3.2 (`пряме посилання <https://wiki.edin.ua/uk/latest/E_SPEC/EDIN_2_0/Instructions_2_0/Uzgodzhennya_c%D1%96n_%D0%86nstrukc%D1%96ya_dlya_postachalnika.html#add-and-rules>`__).
...
Для всіх "промо-пропозицій" можливо обрати `Акції`_, якщо вони були додані мережею і їх дати не конфліктують з датами створюваної Пропозиції на підставі договору з цією мережею. Додатково можливо обрати "Оплату за компенсацію".
...
.. hint::
   ...
   .. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_29.png
      :align: center
...
**Постачальник** може "Додавати нові позиції":

.. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_45.png
   :align: center

Для збереження позиції потрібно заповнити всі обов'язкові поля позначні червоною зірочкою :red:`*` .
...
Товарні позиції в статусі "Чернетка" можливо **"Видалити"** чи **"Надіслати"**, заздалегідь обравши позиції в журналі.

.. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_47.png
   :align: center

Далі ця позиція на стороні **Покупця** (мережі) проходить узгодження, а статус позиції автоматично оновлюється в таблиці розділу.
...
Можливо обрати ключ зі списку чи вводити ключ з клавіатури (при фільтруванні кількома ключами одночасно елементи пошуку повині бути розділені комами). Після цього натисніть - **"Пошук"**:

.. image:: pics_E_Spec_Іnstruction_postachalnik/E_Spec_Іnstruction_postachalnik_34.png
   :align: center
...
Документ що містить коментар позначається символом |чат|.
