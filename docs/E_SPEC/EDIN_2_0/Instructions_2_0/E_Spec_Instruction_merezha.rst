...
Під табличною частиною з позиціями після відправки документа з'являється блок для звязку контрагентів. До кожного коментаря неузгодженого документа може бути додано обгрунтування (максимум 5 файлів розміром кожного не більше 5 МБ в наступних форматах: PDF/JPG/JPEG/PNG/BMP/DOC/DOCX/XLS/XLSX/PPT/PPTX/TXT), що завантажуються по кліку на назву файлу.

.. image:: /E_SPEC/EDIN_2_0/Instructions_2_0/pics_E_Spec_Instruction_merezha/E_Spec_Instruction_merezha_28.png
   :align: center

Після того, як повідомлення набрано потрібно **"Відправити"** коментар контрагенту.
