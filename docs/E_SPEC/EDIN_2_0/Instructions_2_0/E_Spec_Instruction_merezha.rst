...
**Постачальники** відправляють позиції на узгодження, а представник Мережі проводить їх узгодження: із загального списку обирає позиції в статусі "Узгодження" та прийняти рішення (**"Відхилити"** чи **"Прийняти"**) по обраним позиціям:

.. image:: pics_E_Spec_Instruction_merezha/E_Spec_Instruction_merezha_07.png
   :align: center

Також можливо детальніше ознайомитись з пропозицією (перехід через її найменування):

.. image:: pics_E_Spec_Instruction_merezha/E_Spec_Instruction_merezha_08.gif
   :align: center
