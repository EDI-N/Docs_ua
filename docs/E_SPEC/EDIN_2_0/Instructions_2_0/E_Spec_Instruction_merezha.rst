...
4. **Постачальник** зі свого боку підписує комерційний документ ("Товарна специфікація" (`COMDOC_008 <https://wiki.edin.ua/uk/latest/XML/XML-structure.html#comdoc-008>`__)) і відправляє **Покупцю** (мережі). Позиції можливо відсортувати за "Назвою" в алфавітному порядку по спадаючій |sortup| чи за зростанням |sortdown|.
