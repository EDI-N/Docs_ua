...
.. початок блоку для include

Розділ **"Комерційні пропозиції"** доступний на стороні **Покупця** (мережі) та **Постачальника**. При переході в **"Комерційні пропозиції"** відкривається журнал з пропозиціями. **Постачальники** відправляють позиції на узгодження, а представник Мережі проводить їх узгодження: із загального списку обирає позиції в статусі "Узгодження" та прийняти рішення (масово **"Відхилити"** чи **"Прийняти"**) по обраним позиціям:
