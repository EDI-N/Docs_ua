...
.. hint::
   В цьому шаблоні саме **для Вашої ролі** (згідно `Налаштувань рівнів погодження <https://wiki.edin.ua/uk/latest/general_2_0/rabota_s_platformoj_EDIN_2.0.html#doc-search>`__) **вивантажуються усі позиції** (за всіма "Товарними узгодженнями" (AGREEM)) **за якими Ви можете прийняти рішення** за процесом погодження!
...
Всі опрацьовані документи змінюють свій статус відповідно до `Налаштувань рівнів погодження <https://wiki.edin.ua/uk/latest/general_2_0/rabota_s_platformoj_EDIN_2.0.html#doc-search>`__.
