...
В тілі відповіді передається масив об'єктів - `комерційні пропозиції <https://wiki.edin.ua/uk/latest/E_SPEC/EDIN_2_0/API_2_0/Methods/EveryBody/GetNoveltyResponse.html>`__.
