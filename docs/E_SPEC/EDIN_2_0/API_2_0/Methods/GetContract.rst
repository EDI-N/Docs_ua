...
В тілі відповіді в json-форматі передається об'єкт з інформацією про `контракти <https://wiki.edin.ua/uk/latest/E_SPEC/EDIN_2_0/API_2_0/Methods/EveryBody/GetContractResponse.html>`__ .
