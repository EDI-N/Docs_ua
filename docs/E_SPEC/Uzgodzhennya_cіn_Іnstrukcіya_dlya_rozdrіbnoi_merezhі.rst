...
=======================================================================
Документ Товарне узгодження, узгоджений Категорійним менеджером на першому етапі, надходить на наступний зі статусом **Узгодженно** (саме пропозиція що розглядається, може відрізнятися, бо залежить від налаштувань етапів мережі). Для відкриття вхідного документа натисніть на знак редагування.
...
Після зміни статусу позицій, документ змінює статус на «**Готовий до підписання**» й відправляється на наступний етап - Підписання.
...
Після підписання постачальником та відправки, статус узгодження зміниться на **Завершено** та з'явиться ще один підпис у блоці Контрагенти. Тепер обидві візуалізації ЕЦП в зеленому кольорі:
...
У блоці «**Інформація про контракт**» можливо скачати *обгрунтування* - вкладення постачальника, якщо він його додав. Ознайомитися з вкладенням можна зайшовши в товарне узгодження і натиснувши **посилання з назвою обгрунтування**, скачування почнеться автоматично. Максимальний розмір файлу  - 10МБ.
