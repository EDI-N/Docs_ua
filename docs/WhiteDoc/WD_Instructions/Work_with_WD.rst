...
3. Бокова панель сервісу, що складається з:
   ...
   * |approval| **Погодження** - керування погодженнями???????????????????????????????
...
* |toggleON| **"Заборонити делегування"** (за замовчуванням Учасник документобігу може делегувати ????????? заповнення / підписання документів конверта іншій особі);
...
* **Погоджує** - наявність цієї ролі обумовлює запуск процесу **Погодження**; ?????????????? 
