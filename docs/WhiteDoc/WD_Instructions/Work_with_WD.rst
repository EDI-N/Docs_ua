...
.. |plus| image:: pics_Work_with_WD/Work_with_WD_102.png

.. |minus| image:: pics_Work_with_WD/Work_with_WD_103.png
...
**Словник** - поле, що потребує підключення налаштованого довідника (детальніше в розділі `Управління довідниками <https://wiki.edin.ua/uk/latest/WhiteDoc/WD_Instructions/Work_with_WD.html#dictionary>`__). Поле містить "Назву", "Роль" (учасник документообігу, що вводить значення), "Підказку" (текст, що виводиться користувачам), перемикачі властивостей:
...
**Таблиця** - додає в документ таблицю. Таблиця містить "Назву", "Роль" (учасник документообігу, що вводить значення), "Колонки" (кількість колонок після додавання поля редагується в самій таблиці кнопками |plus| / |minus|).
...
.. hint::
   Сервіс WhiteDoc підтримує 3 типи електронного підпису:
      ...
      * Стандартний електронний підпис (поле Підпис);
...
Основне вікно вкладки **"Управління довідниками"** умовно можливо поділити на Провідник (1) та журнал довідників (2), які в ньому знаходяться:
...
* **"Мої довідники"** відображає всі довідники, що були створені авторизованим користувачем і мають відкритий доступ для поточного мейлбокса;
* **"Довідники акаунта"** відображає всі довідники з відкритим доступом до акаунта;
* **"Офіційні довідники"** відображає офіційні довідники (прийнятий стандарт в рамках сервісу WhiteDoc). 
