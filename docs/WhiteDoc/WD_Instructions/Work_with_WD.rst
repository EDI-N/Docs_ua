...
Окрім цього можливо додатково кнопкою **"Додати фільтри"**, що будуть відбирати архівні конверти, конверти з вказаною датою прострочення, ярликами і вказаним напрямком (вхідні/вихідні конверти), типом ролі, одержувачем, призначенням:
