...
Окрім завантаження завершених конвертів при перегляді конверта (кнопка |arrow|) доступне масове завантаження конвертів з журналу документів. Для цього потрібно відмітити потрібні документи і натиснути кнопку **"Завантажити"**:
