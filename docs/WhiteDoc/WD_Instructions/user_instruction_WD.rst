...
* **Будуть прострочені** - журнал всіх конвертів, строк дії яких вже завершується (детальніше про `властивості конверта <https://wiki.edin.ua/uk/latest/WhiteDoc/WD_Instructions/Work_with_WD.html#envelope-properties>`__ при формуванні шаблону). 
