...
* ACS URL = https://wd-api.edin.ua/saml/SSO
* Entity ID = https://wd-api.edin.ua/saml/metadata

Також обирається ідентифікатор назв (в нашому випадку це e-mail) та **"Продовжуємо"** налаштування:

.. image:: pics_WD_admin_panel/WD_admin_panel_098.png
   :align: center
...
.. image:: pics_WD_admin_panel/WD_admin_panel_099.png
   :align: center
...
.. hint::
   ...
   .. image:: pics_WD_admin_panel/WD_admin_panel_102.png
      :align: center
