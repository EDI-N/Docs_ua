...
.. |arrowD| image:: pics_Work_with_WD/Work_with_WD_064.png

.. |arrowU| image:: pics_Work_with_WD/Work_with_WD_064.png

.. |copy| image:: pics_Work_with_WD/Work_with_WD_064.png

.. |switcherOn| image:: pics_Work_with_WD/Work_with_WD_064.png
...
.. image:: pics_WD_admin_panel/WD_admin_panel_00000.png
   :align: center
...
Успішно створена роль відображається в журналі ролей у відповідній вкладці:

.. image:: pics_WD_admin_panel/WD_admin_panel_00000.png
   :align: center

В колонці "Дозволи" відображається один дозвіл та кнопка **"Ще N"**, що відкриває список ще з N дозволами, доступними для цієї ролі: 
