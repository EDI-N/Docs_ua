...
У вкладці можливо додати своїх SSO провайдерів для налаштування авторизації через SSO для своїх корпоративних користувачів. Для того, щоб **"Створити SSO провайдера"** потрібно натиснути на відповідну кнопку та заповнити поля модального вікна:
