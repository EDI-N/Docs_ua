...
.. tabs::
   ...
   .. tab:: "SmartId"
      ...
      Після того, як Ви обрали підписання за допомогою **SmartId** ("ПриватБанк"), генерується qr-код для переходу в мобільний додаток:
   ...
   .. tab:: "Інше"
      ...
      .. admonition:: Встановлення спеціалізованого ПЗ
         ...
         2. Відкрийте програму "ІІТ Клієнт підпису" і зареєструйте нового користувача за допомогою токена bluetooth:
            ...
            2.1. Натисніть значок "+" у додатку;
            2.2. Виберіть тип ключа (якщо Ви використовуєте Bluetooth-токен Bluetooth-пристрою Алмаз-1К виберіть опцію "Ключовий носій");
            2.3. Натисніть кнопку "Прочитати" і знову натисніть "Ключовий носій";
            2.4. Увімкніть пристрій bluetooth і дочекайтеся, поки він відобразиться в програмі;
            2.5. Натисніть на нього та введіть пароль до вибраного ключа;
            2.6. Дочекайтеся завершення реєстрації, після чого Ви зможете підключитися до свого ключа, де зможете отримати ідентифікатор ключа.
