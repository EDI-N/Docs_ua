...
Для роботи з модулем у користувача повинна бути підключена послуга для роботи з API. Для роботи з модулем користувачеві потрібні логін, пароль та ідентифікатор мейлбокса:
...
В блоці "Контактів контрагентів" через кнопку **"+Додати"** можливо вказати кілька електронних адрес (через "," чи ";" в якості розділових знаків):
