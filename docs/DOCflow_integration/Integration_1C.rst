...
Розроблений компанією EDIN інтеграційний модуль EDIN.DocFlow (в подальшому просто модуль) дозволяє працювати з обліковими системами 1С: Підприємство 8.Х :underline:`на звичайних та керованих формах` (надалі ОС) на базі операційної системи Windows. Модуль за замовчуванням дозволяє відправляти структуровані/ неструктуровані документи та переглядати комплекти документів, самі документи з платформи DocFlow, слідкувати за статусом документообігу.
...
.. image:: pics_Integration_1C/Integration_1C_01.png
   :align: center
...
Окрім основних налаштувань модуля під особливості документообігу в Вашій організації можливо також провести налаштування "Схеми обміну" (довідник комплектів): 
...
В вікні "Налаштувань схеми обміну" сказуються:
...
"Контрагенти" - вкладка, в якій додаються та налаштовуютья контрагенти електронного документообігу
   ...
   * ID контракта - вказується ідентифікатор контракта з платформи EDIN.DocFlow (надається співробітником EDIN)
...
5. Підписувати - за активованої відмітки (проставлена галочка) модуль буде автоматично здійснювати спробу підписання документу при його вівантаженні
...
Всі дії з документами проводяться у вкладці **"Вихідні"**. Для початку роботи з документами потрібно обрати період (1) та якщо документи не підтягнутись натиснути **"Відобразити документи 1С"** (2) - в журналі комплектів документів відобразяться всі документи всіх контрагентів (вказані в налаштуваннях схеми) за обраний період:

.. image:: pics_Integration_1C/Integration_1C_09.png
   :align: center

Якщо при відображенні документів в комплекта документів вже вказано "ID_Пакета", то це свідчить про те, що даний комплект вже був вивантажений і для перевірки його статусу можливо **"Завантажити інфо з DocFlow"** (1) (з платформи підвантажиться "Номер комплекта" та "Статус DocFlow"):
