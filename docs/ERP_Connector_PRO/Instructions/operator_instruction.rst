...
В даному розділі виконується налаштуванння сервісів для використання. Для того, щоб ввімкнути частину модулю для роботи з EDI документами (сервіс EDI Network) необхідно відмітити чекером відповідний реквізит:

.. image:: pics_prog_1C_eTTN_3_0_integration/prog_1C_eTTN_3_0_integration_020.png
   :align: center

Після цього в модулі активується вкладка для роботи з сервісом EDI:
