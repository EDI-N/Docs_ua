...
.. матеріал взято з user_instruction
...
Якщо модуль автоматично не розпізнав Контрагента/Організацію/Точку доставки - можливо через подвійний клік мишкою по об'єкту вручну вибрати з довідника ОС (`налаштування <https://wiki.edin.ua/uk/latest/ERP_Connector_PRO/Instructions/operator_instruction.html#doc-settings>`__). 
...
.. important::
   Для роботи з юридично значимими документами в модулі повинні бути `налаштовані ЕЦП <https://wiki.edin.ua/uk/latest/ERP_Connector_PRO/Instructions/operator_instruction.html#etsp>`__ для кожної організації.
