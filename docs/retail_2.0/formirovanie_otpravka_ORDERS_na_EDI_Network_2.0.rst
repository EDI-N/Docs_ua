...
Для формування замовлення для мережі ВІТМАРК-УКРАЇНА, створіть докумень аналогіччно - нптисніть на кнопку **Створити** та виберіть **Замовлення** (**ORDER**). Документ створиться автоматично. У новому документі, всі поля позначені червоною зірочкою :red:`***** є обов'язковими до заповнення**`.
...
У разі неправильного заповнення .XLS файлу Excel, при завантаженні висвітиться повідомлення про помилку з уточннням:
