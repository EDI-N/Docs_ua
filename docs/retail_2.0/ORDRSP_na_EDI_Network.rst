########################################################################################################################
Створення та відправка документа «Підтвердження замовлення» (ORDRSP) на базі інших електронних документів
########################################################################################################################
...
**Товарні позиції** переносяться з "Замовлення". Можливо коригувати значення **Ціна без ПДВ** та **Підтверджена кількість** товару рямо в таблиці чи **"Змінити"** "Дані позиції" в розширеній формі після натискання на штрих-код позиції:
