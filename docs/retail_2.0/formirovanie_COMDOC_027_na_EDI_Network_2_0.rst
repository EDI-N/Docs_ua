#############################################################################################################
Формування "Товарної накладної" (COMDOC_027) для мережі "МЕТРО"
#############################################################################################################
...
Дана інструкція описує документообіг `"Товарною накладної" (COMDOC_027) <https://wiki.edin.ua/uk/latest/XML/XML-structure.html#comdoc-027>`__ на платформі EDI Network між Постачальником та Мережею "МЕТРО". Ініціатором документообігу виступає Постачальник.

1 Формування "Товарної накладної" (COMDOC_027) для торгової мережі "МЕТРО"
============================================================================================
