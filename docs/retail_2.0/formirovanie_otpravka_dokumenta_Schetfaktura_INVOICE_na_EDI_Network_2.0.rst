##################################################################################################################
Формування та відправка документа «Рахунок» (INVOICE) на платформі EDI Network
##################################################################################################################
...
.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_01.png
   :align: center
...
.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_02.png
   :align: center
...
.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_03.png
   :align: center
...
.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_04.png
   :align: center
...
.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_05.png
   :align: center

Після внесення всіх даних в документі, натисніть кнопку «**Зберегти**», потім «**Надіслати**».

.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_06.png
   :align: center
...
Блоки "Додаткова інформація", "Інформація про постачальника" необов'язкові для заповнення; блок "Разом" розраховується автоматично.

.. image:: pics_INVOICE_na_EDI_Network_2.0/INVOICE_na_EDI_Network_07.png
   :align: center
