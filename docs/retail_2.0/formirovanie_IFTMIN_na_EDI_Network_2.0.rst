...
Створений таким чином документ «**Інструкція про транспортування**» (**IFTMIN**) є аналогічним до документу, створеному на основі **Замовлення**, однак всі поля в такому віпадку необхідно заповнювати самостійно.
...
#. **Дата доставки** - попередня дата відправки поставки, за замовчуванням вказана поточна дата
