...
Створення документа відбувається на підставі «**Замовлення**». Щоб сформувати «**Інструкцію про транспортування** (**IFTMIN**)» на підставі **Замовлення** (ORDER), увійдіть в папку «**Вхідні**» і виберіть **замовлення**, за яким потрібно зробити інструкцію.
...
У відкритому документі, натисніть кнопку «**Сформувати**» і виберіть зі списку документ «**Інструкція про транспортування**».
