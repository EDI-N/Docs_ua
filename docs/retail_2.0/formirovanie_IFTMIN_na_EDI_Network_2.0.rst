#############################################################################################################
Формування документа «Інструкція про транспортування» (IFTMIN) на платформі EDI Network
#############################################################################################################
...
.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_01.png
   :align: center

Для формування IFTMIN виберіть «Інструкція про транспортування» на формі-підказці, документ створиться автоматично.

.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_02.png
   :align: center
...
.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_07.png
   :align: center
...
.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_05.png
   :align: center
...
.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_04.png
   :align: center
   
У вікні з'явиться **Форма** для заповнення необхідних реквізитів документа. Всі поля, позначені червоною зірочкою :red:`*` - **обов'язкові до заповнення**.
...
.. image:: pics_IFTMIN_na_EDI_Network_2.0/IFTMIN_na_EDI_Network_06.png
   :align: center
