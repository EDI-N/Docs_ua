...
.. warning::
   **Обмін документом "Додаток до договору 7А" (METRO_7A) передбачає можливість прострочення документа. У цього документа є дедлайн на підписання зі сторони Постачальника - ця дата вираховується: значення в полі PromotionalPriceStartDate мінус 7 днів. Після дати дедлайну документ стає заблокованим (статус документа - "Заблокований"), всі дії з ним неможливі (документообіг завершено).**
