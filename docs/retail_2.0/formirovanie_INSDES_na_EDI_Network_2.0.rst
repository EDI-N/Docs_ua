################################################################################################################################
Формування та відправка документа «Інструкція по доставці» (INSDES) на платформі EDI Network
################################################################################################################################
...
Дана інструкція описує порядок формування та відправки документа «**Інструкція по доставці**» (INSDES) на платформі EDI Network.
