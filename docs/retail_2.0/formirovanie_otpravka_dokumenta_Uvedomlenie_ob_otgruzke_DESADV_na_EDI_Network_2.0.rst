...
Після збереження документ можливо знайти в папці **"Чернетки"**. Відправлений документ автоматично потрапляє в папку **"Надіслані"** і буде знаходитись в ланцюжку документів разом із "Замовленням":
...
.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ початок блоку для Desadv_from_Ordrsp_Silpo1
...
.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ кінець блоку для Desadv_from_Ordrsp_Silpo1

.. image:: /retail_2.0/pics_DESADV_na_EDI_Network_2.0/DESADV_na_EDI_Network_011.png
   :align: center

.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ початок блоку для Desadv_from_Ordrsp_Silpo2
...
.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ кінець блоку для Desadv_from_Ordrsp_Silpo2
...
.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ початок блоку для Desadv_from_Ordrsp_Silpo3
...
.. інструкцію для Сільпо перероблено, це наслідування не повинно працювати \ кінець блоку для Desadv_from_Ordrsp_Silpo3
