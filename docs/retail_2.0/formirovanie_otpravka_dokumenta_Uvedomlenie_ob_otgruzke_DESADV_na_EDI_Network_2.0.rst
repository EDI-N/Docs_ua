...
.. attention::
   Немає можливості сформувати нову ТТН з однаковими даними за номером і датою Замовлення, номером і датою "Повідомлення про відвантаження" (DESADV) згідно налаштувань Вантажоодержувача.
