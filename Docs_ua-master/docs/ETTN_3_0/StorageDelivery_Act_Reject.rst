...
Після відхилення документ змінює свій статус на :red:`"Відхилено водієм/перевізником"`, а кінцевий статус документа разом з ПІБ особи, що відмовилась від підписання, датою та текстом причини відхилення відображається в шапці документа:

.. image:: pics_StorageDelivery_Act_Reject/StorageDelivery_Act_Reject_003.png
   :align: center

Після відхилення Акта функціонал по роботі з "е-ТТН" все ще недоступний. Ініціатору відхилення (тут **"Перевізнику"**) потрібно відкрити та оновити "е-ТТН", до якого складався Акт, підписавши та надіславши зміни:
