Формування та відправка документа «Підтвердження заявки на транспортування» (IFTMBC) на платформі
######################################################################################################
...
Дана інструкція описує порядок формування та відправки документа «Підтвердження заявки на транспортування» (IFTMBС) на WEB платформі.
...
Формування документа «Підтвердження заявки на транспортування» (IFTMBС)
================================================================================

Створення документа відбувається на підставі вхідного документа **«Заявка на транспортування»**. Для зручності пошуку, виберіть потрібний фільтр і відкрийте вхідний документ.
...
Для створення документа **IFTMBC**, у відкритому документі натисніть кнопку **«Сформувати»** і виберіть зі списку документ **«Підтвердження заявки на транспортування»**.

.. image:: pic_formirovanie_otpravka_dokumenta_Podtverzhdenie_zakaza_transportirovki_IFTMBC/formirovanie_IFTMBC_06.png
   :align: center

Заповнення документа «Підтвердження заявки на транспортування» (IFTMBС)
========================================================================

Заповнення документа «Підтвердження заявки на транспортування» передбачає два способи:
...
Кількість рядків у другому блоці, як і колонки «Типорозмір» і «Опис» автоматично формуються на підставі документа «Заявка на транспортування» з блоку «Дані по транспорту». Решта колонок заповнюються вручну.
...
По отриманню файла статус документа «**Заявка на транспортування**» змінюється на «**транспортування закрите**».

.. important:: **Увага!** Після отримання статусу «**транспортування закрите**» над документами **«Заявка на транспортування»** і **«Підтвердження заявки на транспортування»** не можна проводити ніяких дій.
