...
.. important:: **Увага!** Для коректного формування документа **Видаткова накладна (Comdoc)**, необхідно заповнити Товарний довідник. Ви можете переглянути `Інструкцію щодо заповнення довідника <https://wiki.edin.ua/uk/latest/general/Zapolnenie_Tovarnogo_spravochnika.html>`_.
