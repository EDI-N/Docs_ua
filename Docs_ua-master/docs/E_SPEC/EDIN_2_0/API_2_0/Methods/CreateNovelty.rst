...
В тілі відповіді передаються збережені `дані комерційної пропозиції <https://wiki.edin.ua/uk/latest/E_SPEC/EDIN_2_0/API_2_0/Methods/EveryBody/CreateNoveltyResponse.html>`__.
