...
Постачальник може редагувати "Кількість відвантаженого товару", "Одиниці виміру", "Ціну без ПДВ" та "Ставку ПДВ" прямо в таблиці чи **"Змінити"** дані позиції в розширеній формі "Дані товару" після натискання на штрихкод позиції:
