...
Для реєстрації в сервісі перейдіть за посиланням https://doc.edin.ua. У формі авторизації натисніть «Зареєструватися»:
...
2 Авторизація
--------------
Для авторизації на платформі перейдіть за посиланням https://doc.edin.ua/auth, введіть свій логін = Email та натисніть «Далі», або натисніть **Авторизація з Google** та виберіть пошту за допомогою якої ви реєструвалися: 
